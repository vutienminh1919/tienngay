...
class List_import_cost_model extends CI_Model
{

	private $collection = 'list_import_cost';
	...
	public function find_condition($condition, $limit, $offset)
	{
	...
	public function find_count_condition($condition)
	{
		$where = array();
		$mongo = $this->mongo_db;

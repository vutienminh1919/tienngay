...
class Createkpi_telesale_model extends CI_Model
{

	private $collection = 'createkpi_telesale';
	...
	public function __construct()
	{
		...
		$this->manager = new MongoDB\Driver\Manager($this->config->item("mongo_db")['dsn']);
	...
	public function find_where_get($condition){

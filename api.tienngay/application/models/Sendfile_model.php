...
class Sendfile_model extends CI_Model
{

	private $collection = 'sendfile';
	...
	public function getDataByRole($condition = array(), $limit = 30, $offset = 0)
	{
		...
		if (isset($condition['status_sendFile'])) {
			$where['status'] = $condition['status_sendFile'];
		}
	...
	public function getCountByRole($condition = array())
	{
		...
		if (isset($condition['status_sendFile'])) {
			$where['status_sendFile'] = $condition['status_sendFile'];
		}

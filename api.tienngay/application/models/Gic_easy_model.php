...
class Gic_easy_model extends CI_Model
{
	private $collection = 'gic_easy';
  ...
  public function getGic($condition = array(),$limit = 30, $offset = 0, $total = false) {
	...
	public function find_where_many($condition)
	{

...
class Report_kpi_commission_pgd_model extends CI_Model
{

	private $collection = 'report_kpi_commission_pgd';
	...
	public function find_where_search($condition)
	{
		return $this->mongo_db
			->get_where($this->collection, $condition);
	}

	public function get_find_where($condition){

...
class Borrowed_noti_model extends CI_Model
{

	private $collection = 'borrowed_noti';
	...
	public function getDataByRole($condition = array(), $limit = 30, $offset = 0)
	{
		...
		if (isset($condition['status_borrowed'])) {
			$where['status'] = $condition['status_borrowed'];
		}
	...
	public function getCountByRole($condition = array())
	{
		...
		if (isset($condition['status_borrowed'])) {
			$where['status_borrowed'] = $condition['status_borrowed'];
		}

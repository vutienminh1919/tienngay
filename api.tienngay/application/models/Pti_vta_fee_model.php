...
class Pti_vta_fee_model extends CI_Model
{
	private $collection = 'pti_vta_fee';
	...
	public function find_where_by_packet($condition)
	{
		return $this->mongo_db
			->order_by(array('number_packet' => 'ASC'))->get_where($this->collection, $condition);
	}

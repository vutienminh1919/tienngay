...
class BankVimo extends REST_Controller{
    public function __construct($config = 'rest') {
        parent::__construct($config);
        $this->load->model("bank_vimo_model");
    ...
    public function get_all_post(){
        ...
        $bank = $this->bank_vimo_model->find();
        $response = array(
    ...
    public function get_bank_name_post(){
        ...
        $bank = $this->bank_vimo_model->findOne(array('bank_id' => $bank_id));
        $response = array(
            'status' => REST_Controller::HTTP_OK,
            'data' => $bank
        );

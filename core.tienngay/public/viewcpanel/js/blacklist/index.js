...
$( document ).ready(function() {
    function DataList() {
                    ...
                    let html_feature =
                        '<div class="btn-group" style="text-align: center">' +
                            '<button type="button" ' +
                                ...
                                ' Chức năng&nbsp;<i class="fa fa-bars" aria-hidden="true" ' +
                                ' style="font-style: 14px"></i> ' +
                            '</button>' +
                            '<ul class="dropdown-menu"> ' +
                                '<li>' +
                                    '<a class="dropdown-item detail" id="blackDetail" onclick="detailBlacklistFeature(this)"' +
                                        ' href="" ' +
                                        ' data-id="'+ $data._id +'" ' +
                                        ' data-name="' + $data.name +'" ' +
                                        ...
                                        ' data-id-property="' + $data.id_property +'" ' +
                                        ' data-id-hcns="' + $data.id_hcns +'" ' +
                                        ' data-id-exemtion="' + $data.id_exemtion +'" ' +
                                        ' data-id-contract="' + $data.id_contract_exemtion +'" ' +
                                        ' data-id-blacklist="' + $data._id +'" ' +
                            ...
                            '</ul>' +
                        '</div>';
                    $(_columns[index]).append(html_feature);
                } else {
                    $(_columns[index]).text(_value);
                }
            });
        ...
        this.exportExcel = function (event) {
            ...
            var wb = XLSX.utils.table_to_book(_tableExport, { sheet: "sheet1" });

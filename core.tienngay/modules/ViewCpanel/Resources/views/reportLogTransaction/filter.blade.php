            ...
            <div class="card-body">
                <form id="search-form" method="post" action="{{$filterUrl}}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="request_by" class="form-control" value="" autocomplete="off" placeholder="Người gửi yêu cầu">
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label"><strong>Người duyệt</strong></label>
                        <input type="text" name="approve_by" class="form-control" value="" autocomplete="off" placeholder="Người duyệt yêu cầu">
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label"><strong>Mã hợp đồng</strong></label>
                        <input type="text" name="code_contract_disbursement" class="form-control" value="" autocomplete="off" placeholder="Mã hợp đồng">
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label"><strong>Mã phiếu thu</strong></label>
                        <input type="text" name="trancode" class="form-control" value="" autocomplete="off" placeholder="Mã phiếu thu">
                    </div>
        ...
        <div class="button_functions">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-customer" aria-labelledby="dropdownMenu">
                    <li><a id="export-excel" class="dropdown-item" file-name="report_thoi_gian_xu_ly_lenh" clone-table="export-object" report-table1="report-object1" report-table2="report-object2"  report-table3="report-object3" href="javascriptvoid:0">Xuất báo cáo</a></li>
              </ul>
            </div>
        </div>
    </div>

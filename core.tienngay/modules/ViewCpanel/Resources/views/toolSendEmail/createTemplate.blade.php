...
@section('title', 'Thêm Mới Template Email')
@section('css')
    <style type="text/css">
...
<section class="main-content">
    ...
    <div class="card">
      <div class="card-header">
        <legend class="col-md-6 tilte_top_tabs">Thêm Mới Template Email</legend>
      
      <div class="card-body">
        <div class="middle table_tabs">
          <div class="row">
            <legend style="color: #2dbbff; font-size: 20px; padding-left:100px;">Thông Tin Chi Tiết Template</legend>
            <div class="row justify-content-center">
              ...
              <div class="row col-md-12 col-lg-8">
                  <div class="col-md-12 col-sm-12">
                      ...
                      <input style="font-size:15px" type="text" class="form-control" id="code" name="code" placeholder="example: truyen-thong-noi-bo ">
                  </div>

                  <div class="col-md-12 col-sm-12">
                      <label for="subject" class="form-label" style="font-size:20px">Tiêu đề&nbsp;<span class="text-danger">*</span></label>
                      <input style="font-size:15px" type="text" class="form-control" id="subject" name="subject" placeholder="Tiêu đề email">
                  </div>
                  ...
                  <div class="col-md-12 col-sm-12">
                      ...
                      <textarea style="font-size:15px" placeholder="Template của email" rows="10" cols="50" type="text" class="form-control" id="message" name="message"></textarea>
                  </div>
              ...
              <div class="modal-footer" style="border-top: 2px solid #dee2e6" >
                  <button style="font-size:15px" id="typeCreate" type="submit" class="btn btn-success">Tạo mới</button>
...
<script>
  $(document).ready(function () {
    $('#typeCreate').on('click', function(event) {

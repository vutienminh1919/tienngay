        ...
        <div class="button_functions">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-customer" aria-labelledby="dropdownMenu">
                    <li><a id="export-excel" class="dropdown-item" file-name="report_bang_lai_thuc" clone-table="export-object" href="javascriptvoid:0">Xuất báo cáo</a></li>
                    <li><a id="import_record" class="dropdown-item" href="javascriptvoid:0">Import dừng tính lãi</a></li>
              </ul>
            </div>
        </div>
    </div>

...
@section('title', 'Export VBI SXH BN')
...
<section class="main-content" hidden>
    <div class="container" style="max-width: 95% !important">
        <h5 class="tilte_top_tabs">
            Export Bảo Hiểm VBI Sốt Xuất Huyết Bán Ngoài
        </h5>
        <div class="row" style="align-items: right;">
            <div class="col-xs-12 col-12">
                <li><a id="export-excel" class="dropdown-item" file-name="bh-vic-sxh-bn" clone-table="export-object" href="javascriptvoid:0">Xuất báo cáo</a></li>
            </div>
        </div>
    </div>
</section>
...
<table id="export-object" class="table table-striped" hidden >
    ...
    <tbody align="center" id="table-rows">
        <tr id="clone-item" data-id="" style="background: #037734, color: #fff">
            ...
            <td data-attr='vbi_sxh.so_id_vbi' zero-before='true'></td>
            ...
            <td data-attr='vbi_sxh.response_code' func='statusBH'></td>
        </tr>
    </tbody>
</table>
@endsection

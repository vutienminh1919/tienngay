<div class="btn_list_filter text-right mt-0">
    <div class="button_functions btn-fitler">
        ...
        <div style="margin-right: -170px; margin-top: 10px; width:auto;" id="fillter-content" class="dropdown-menu drop_select dropdown-customer" aria-labelledby="dropdownMenuButton">
            <div class="card-body">
                <form id="search-form" method="GET" action="{{route('viewcpanel::macom.cost.index')}}">
                    @csrf
                    <div class="row">
                        <dir class="col-12">
                        ...
                        <div class="row">
                            <div class="col-6" style="">
                                <div class="date-container">
                                    <input style="color:black; border-radius: 5px;" id="date" type="text" name="start_month" placeholder="Từ tháng"/>
                                    <i class="date-icon fa fa-calendar" aria-hidden="true"></i>
                                </div>
                            </div>
                            <div class="col-6" style="">
                                <div class="date-container2">
                                    <input style="color:black; border-radius: 5px;" id="date2" type="text" name="end_month" placeholder="Đến tháng"/>
                                    <i class="date-icon fa fa-calendar" aria-hidden="true"></i>
                                </div>
                            </div>
                        </div>

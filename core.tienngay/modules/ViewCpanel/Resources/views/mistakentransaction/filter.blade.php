            ...
            <div class="card-body">
                <form id="search-form" method="post" action="{{$filterUrl}}">
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label"><strong>Ngày khách thanh toán</strong>
                        </label>
                        <div style="padding-left: 20px;">
                            <label class="form-label"><strong>Từ ngày:</strong>
                            <input type="text" class="form-control" name="start_date" id="start-date" placeholder="yyyy-mm-dd" autocomplete="off">
                            <label class="form-label"><strong>Đến ngày:</strong>
                            <input type="text" class="form-control" name="end_date" id="end-date" placeholder="yyyy-mm-dd" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label"><strong>Chọn Khu Vực</strong></label>
                        @foreach($codeArea as $code)
                            <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="{{$code}}" name="codeArea[]">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="tn_trancode" class="form-control" value="" autocomplete="off" placeholder="Mã phiếu thu">
                    </div>
                    <div class="form-group mb-3">

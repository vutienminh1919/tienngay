...
@section('content')
    <div class="create_report">
        ...
        @endif
        <legend class="col-md-6" style="padding-bottom: 10px; border-bottom: 1px solid #dee2e6;margin-bottom: 50px;margin-top: 30px;color: #009535;">Cập Nhật Biên Bản Ghi Nhận Vi Phạm</legend>
        <div class="new_report">
            <form id="mainForm" action='{{url("cpanel/reportsKsnb/updateReport/$detail->_id")}}' method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-6">
                  <legend style="color: #2dbbff; font-size: 20px;">Thông Tin Lỗi Vi Phạm</legend>
                  <div class="mb-3">
                    <label  class="form-label">Tìm kiếm lỗi vi phạm</label>
                    <input type="text" class="form-control" id="search-input" placeholder="Nhập mô tả lỗi vi phạm..." autocomplete="off">
                  </div>
                  <div class="mb-3">
                      ...
                      <select @if($errors->has('quote_document')) style="border: 1px solid red" @endif name="quote_document" id="quote_document" class="form-control" id="quote_document" value="{{old ('quote_document','')}}">
                        <option value="{{$detail->quote_document}}">{{$detail->quote_document}}</option>
                      </select>
                    ...
                    <div class="mb-3">
                      <label  class="form-label">Quyết định số&nbsp; <span class="text-danger">*</span><i data-bs-toggle="tooltip" title="" data-bs-original-title="Văn bản/Quyết định số" style="color: #047734" class="fa fa-question-circle-o" aria-hidden="true"></i></label>
                      <select @if($errors->has('no')) style="border: 1px solid red" @endif name="no" id = "no" class="form-control" id="no" value="{{old ('no','')}}">
                        <option value="{{$detail->no}}">{{$detail->no}}</option>
                      </select>
                      @if($errors->has('no'))
                    ...
                    <div class="mb-3">
                      ...
                      <select @if($errors->has('sign_day')) style="border: 1px solid red" @endif name="sign_day" class="form-control" id="sign_day" value="{{old ('sign_day','')}}">
                        <option value="{{$detail->sign_day}}">{{$detail->sign_day}}</option>
                      </select>
                  ...
                  <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <select @if($errors->has('code_error')) style="border: 1px solid red" @endif name="code_error" class="form-control" id="code_error">
                        @foreach($listErorrsByType as $codeErrors)
                        <option value="{{$codeErrors['code_error']}}" @if ($detail->code_error == $codeErrors['code_error']) selected @endif>{{$codeErrors['code_error']}}</option>
                        @endforeach
                      </select>
                    ...
                    <div class="mb-3">
                      ...
                      <select @if($errors->has('discipline')) style="border: 1px solid red" @endif  name= "discipline" id="discipline" class="form-control" >
                        <option value="{{$detail->discipline}}">{{$detail->discipline_name}}</option>
                      </select>
                    ...
                    <div class="mb-3">
                      ...
                      <select @if($errors->has('punishment')) style="border: 1px solid red" @endif name= "punishment" id="punishment" class="form-control" >
                        <option value="{{$detail->punishment}}">{{$detail->punishment_name}}</option>
                      </select>
                    ...
                    <div class="mb-3">
                      ...
                      <textarea @if($errors->has('description')) style="border: 1px solid red" @endif type="text" name="description" class="form-control " id="created_by">{{$detail['description']}}</textarea>
                    ...
                    <div class="mb-3">
                      ...
                      <textarea @if($errors->has('description_error')) style="border: 1px solid red" @endif type="text" name="description_error" class="form-control " id="created_by">{{$detail['description_error']}}</textarea>
                ...
                <div class="col-md-6">
                  ...
                  <div class="mb-3">
                    ...
                    <select @if($errors->has('store_name')) style="border: 1px solid red" @endif type="text" name="store_name" class="form-control" id="store_name"
                  ...
                  <div class="mb-3">
                    ...
                    <select @if($errors->has('email_tpgd')) style="border: 1px solid red" @endif type="text" name="email_tpgd" class="form-control" id="email_tpgd"
                  ...
                  <div class="mb-3">
                    ...
                    <select @if($errors->has('user_email')) style="border: 1px solid red" @endif type="text" name="user_email" class="form-control" id="user_email"
                  ...
                  <div class="mb-3">
                    <label  class="form-label">Tên nhân viên vi phạm&nbsp; <span class="text-danger">*</span></label>
                      <input @if($errors->has('user_name')) style="border: 1px solid red" @endif type="text" name="user_name" class="form-control" id="user_name" value="{{$detail->user_name}}">
                ...
                <div class="modal-footer">
                    <button id="typeCreate" type="submit" class="btn btn-primary">Cập nhật</button>

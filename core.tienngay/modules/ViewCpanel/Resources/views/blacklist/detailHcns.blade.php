...
@section('title', 'Thông Tin Nhân Sự Nghỉ Việc')
@section('css')
    <style type="text/css">
  ...
  <form id="mainForm" action='' method="post" enctype="multipart/form-data">
    ...
    <div class="row col-md-12 col-lg-8">
      <div class="col-md-6 col-sm-6">
        ...
        <input type="text" class="form-control" id="user_name" name="user_name" value="{{$detail->user_name}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="user_phone" class="form-label">Số điện thoại&nbsp;</label>
        <input type="text" class="form-control" id="user_phone" name="user_phone" value="{{$detail->user_phone}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="user_identify" class="form-label">Số Cmnd/cccd/hộ chiếu&nbsp;<span class="text-danger">*</span></label>
        <input type="text" class="form-control" id="user_identify" name="user_identify" value="{{$detail->user_identify}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="user_identify" class="form-label">Số hộ chiếu&nbsp;</label>
        <input type="text" class="form-control" id="user_passport" name="user_passport" value="{{$detail->user_passport}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="date_range" class="form-label">Ngày cấp&nbsp;</label>
        <input type="text" class="form-control" id="date_range" name="date_range" value="{{$detail->date_range}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="issued_by" class="form-label">Nơi cấp&nbsp;</label>
        <input type="text" class="form-control" id="issued_by" name="issued_by" value="{{$detail->issued_by}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="user_email" class="form-label">Email cá nhân&nbsp;</label>
        <input type="text" class="form-control" id="user_email" name="user_email" value="{{$detail->user_email}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="temporary_address" class="form-label">Địa chỉ tạm trú&nbsp;</label>
        <input type="text" class="form-control" id="temporary_address" name="temporary_address" value="{{$detail->temporary_address}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="permanent_address" class="form-label">Địa chỉ thường trú&nbsp;</label>
        <input type="text" class="form-control" id="permanent_address" name="permanent_address" value="{{$detail->permanent_address}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="day_on" class="form-label">Ngày bắt đầu&nbsp;</label>
        <input type="text" class="form-control" id="day_on" name="day_on" value="{{$detail->day_on}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="day_off" class="form-label">Ngày nghỉ việc&nbsp;</label>
        <input type="text" class="form-control" id="day_off" name="day_off" value="{{$detail->day_off}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="work_place" class="form-label">Địa điểm làm việc&nbsp;</label>
        <input type="text" class="form-control" id="work_place" name="work_place" value="{{$detail->work_place}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="room" class="form-label">Phòng ban&nbsp;</label>
        <input type="text" class="form-control" id="room" name="room" value="{{$detail->room}}" disabled>
      </div>
      <div class="col-md-6 col-sm-6">
        <label for="position" class="form-label">Chức vụ&nbsp;</label>
        <input type="text" class="form-control" id="position" name="position" value="{{$detail->position}}" disabled>
      </div>

      <div class="col-md-6 col-sm-6">
        <label for="reason_for_leave" class="form-label">Lý do nghỉ việc&nbsp;</label>
        <textarea type="text" class="form-control" id="reason_for_leave" name="reason_for_leave" disabled>{{$detail->reason_for_leave}}</textarea>
      </div>

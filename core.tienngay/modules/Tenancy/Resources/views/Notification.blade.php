                            ...
                            <table border='0' cellpadding='0' cellspacing='0'
                                ...
                                <tr>
                                    <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'><p
                                        ...
                                        <p>Hiện tại đang có các hợp đồng thuê mặt bằng cần thanh toán</p>
                                        ...
                                        <table style='width:100%;border: 1px solid #cccccc'>
                                            ...
                                            <tr>
                                                ...
                                                <th scope='col' style="border: 1px solid #cccccc">Hợp đồng số(phụ lục)</th>
                                                ...
                                                <th scope='col' style="border: 1px solid #cccccc">Tổng tiền thanh toán</th>
                                                <th scope='col' style="border: 1px solid #cccccc">Ngày thanh toán thực tế</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style='padding:5px;border:1px solid #cccccc;text-align: center'>{{$item['hop_dong_so']}}</td>
                                                    <td style='padding:5px;border:1px solid #cccccc;text-align: center'>{{$item['status']=='1' ? 'Chưa thanh toán' : 'Đã thanh toán'}}</td>
                                                    ...
                                                    <td style='padding:5px;border:1px solid #cccccc;text-align: center'>{{date('d/m/Y',($item['ngay_thanh_toan_tt']))}}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>

...
<head>
    ...
    <title>Phiếu Ghi nhận kỳ thanh toán quá hạn </title>
                                ...
                                <tr>
                                    <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'><p
                                        ...
                                        <strong>Kính gửi: <span> @if($user_email=='ducta@tienngay.vn') CFO Nguyễn Ngọc
                                                Bích @else Bộ phận kế toán @endif </span></strong>
                                        <p>Hiện tại đang có các hợp đồng thuê mặt bằng quá hạn cần thanh toán</p>
                                        ...
                                        <table style='width:100%;border: 1px solid #cccccc'>
                                            ...
                                            @foreach ($data as $key=> $item)
                                                <tr>
                                                    ...
                                                    <td style='padding:5px;border:1px solid #cccccc'>{{number_format($item['one_month_rent'])}}</td>
                                                    <td style='padding:5px;border:1px solid #cccccc'>{{$item['ngay_thanh_toan']}}</td>

...
use Modules\AssetLocation\Http\Middleware\AuthAssetLocation;
use Modules\AssetTienNgay\Http\Middleware\CheckDoc;

class AssetLocationServiceProvider extends ServiceProvider
{
    /**
     * @var string $moduleName
     */
    protected $moduleName = 'AssetLocation';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'assetlocation';
    ...
    public function boot()
    {
        ...
        $router->aliasMiddleware('auth_asset_location', AuthAssetLocation::class);
    }

                                ...
                                <table border='0' cellpadding='0' cellspacing='0'
                                    ...
                                    <tr>
                                        <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'>
                                            ...
                                            <p>Hiện tại phiếu yêu cầu ấn phẩm của Phòng giao dịch&nbsp;{{$store_name}}&nbsp;
                                                cho kế hoạch&nbsp;"{{$plan_name}}"&nbsp;đã được xác nhận</p>
                                            <p>Kính nhờ Anh/Chị vào phê duyệt phiếu yêu cầu trên.</p>

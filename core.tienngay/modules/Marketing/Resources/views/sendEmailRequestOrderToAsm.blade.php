                                ...
                                <table border='0' cellpadding='0' cellspacing='0'
                                    ...
                                    <tr>
                                        <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'>
                                            ...
                                            <p>Hiện tại Phòng giao dịch&nbsp;{{$store_name}}&nbsp;vừa tạo xong phiếu yêu cầu ấn phẩm
                                                để phục vụ cho kế hoạch&nbsp;"{{$plan_name}}"</p>
                                            <p>Kính nhờ Anh/Chị phê duyệt phiếu yêu cầu </p>

                                ...
                                <table border='0' cellpadding='0' cellspacing='0'
                                    ...
                                    <tr>
                                        <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'>
                                            ...
                                            <h2 style=''>Thông Báo Yêu Cầu Ngân Sách Ấn Phẩm</h2>
                                            <strong>Kính gửi: Anh/Chị,</strong>
                                            <p>Hiện tại ngân sách dự toán&nbsp;"{{$plan_name}}"&nbsp;đã được tạo thành công</p>
                                            <p>Kính nhờ Anh/Chị vào xác nhận và triển khai các quy trình tiếp theo.</p>

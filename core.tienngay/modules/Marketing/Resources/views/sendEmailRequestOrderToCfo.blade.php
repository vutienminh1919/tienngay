...
<head>
    ...
    <title>Thông báo yêu cầu ngân sách dự toán ấn phẩm</title>
    <style>
                                ...
                                <table border='0' cellpadding='0' cellspacing='0'
                                    ...
                                    <tr>
                                        <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'>
                                            ...
                                            <h2 style=''>Thông Báo Yêu Cầu Ngân Sách Dự Toán Ấn Phẩm</h2>
                                            <strong>Kính gửi: CFO&nbsp;{{$user}},</strong>
                                            <p>Hiện tại ngân sách dự toán&nbsp;"{{$plan_name}}"&nbsp;đã được CCO và TP Marketing 
                                                xác nhận.
                                            </p>
                                            <p>Kính nhờ CFO vào phê duyệt yêu cầu ngân sách trên.</p>
                                            <p>Xem chi tiết và phê duyệt <a href='{{$url}}'>tại đây</a></p>

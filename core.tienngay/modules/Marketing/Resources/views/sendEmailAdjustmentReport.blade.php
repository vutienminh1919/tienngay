...
<head>
    ...
    <title>Thông báo xác nhận {{$type}} phiếu điều chỉnh</title>
    <style>
                                ...
                                <table border='0' cellpadding='0' cellspacing='0'
                                    ...
                                    <tr>
                                        <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'>
                                            ...
                                            <h2 style=''>Thông báo xác nhận {{$type}} phiếu điều chỉnh</h2>
                                            <strong>Kính gửi Anh/Chị,</strong>
                                            <p>Hiện tại phiếu điều chỉnh ấn phẩm của Phòng giao dịch&nbsp;{{$store_name}}&nbsp;&nbsp;đã được xác nhận {{$type}}</p>
                                            <p>Kính nhờ Anh/Chị vào thực hiện các bước tiếp theo.</p>

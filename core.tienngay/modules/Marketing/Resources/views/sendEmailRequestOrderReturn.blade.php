                                ...
                                <table border='0' cellpadding='0' cellspacing='0'
                                    ...
                                    <tr>
                                        <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'>
                                            ...
                                            <h2 style=''>Thông Báo Yêu Cầu Ấn Phẩm</h2>
                                            <strong>Kính gửi: Anh/Chị,</strong>
                                            @if (!empty($store_name))
                                                <p>Phiếu yêu cầu ấn phẩm Phòng giao dịch&nbsp;{{$store_name}}&nbsp;cho kế hoạch&nbsp;"{{$plan_name}}"&nbsp;chưa được xác nhận.</p>
                                            @else
                                                <p>Yêu cầu ngân sách dự toán ấn phẩm&nbsp;"{{$plan_name}}"&nbsp; chưa được xác nhận.</p>
                                            @endif
                                            <p>Đề nghị Anh/Chị vào kiểm tra, chỉnh sửa lại cho phù hợp và tiến hành xử lý

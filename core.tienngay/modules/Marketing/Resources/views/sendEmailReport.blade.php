...
<head>
    ...
    <title>Thông báo báo cáo tồn kho ấn phẩm</title>
    <style>
                                ...
                                <table border='0' cellpadding='0' cellspacing='0'
                                    ...
                                    <tr>
                                        <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'>
                                            ...
                                            <h2 style=''>Thông báo báo cáo tồn kho ấn phẩm</h2>
                                            <strong>Kính gửi Anh/Chị,</strong>
                                            <p>Hiện tại báo cáo tồn kho ấn phẩm của Phòng giao dịch&nbsp;{{$store_name}}&nbsp;đã được tạo</p>

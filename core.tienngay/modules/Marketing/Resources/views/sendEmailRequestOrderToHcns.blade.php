                                ...
                                <table border='0' cellpadding='0' cellspacing='0'
                                    ...
                                    <tr>
                                        <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'>
                                            ...
                                            <strong>Kính gửi: Bộ Phận Hành Chính Nhân Sự,</strong>
                                            <p>Hiện tại ngân sách dự toán&nbsp;"{{$plan_name}}"&nbsp;đã được CEO phê duyệt.
                                            </p>
                                            <p>
                                                Kính đề nghị BP HCNS mua sắm theo ấn, vật phẩm theo đúng ngân sách dự toán trên.
                                            </p>

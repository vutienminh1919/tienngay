                                ...
                                <table border='0' cellpadding='0' cellspacing='0'
                                    ...
                                    <tr>
                                        <td style='font-family: sans-serif; font-size: 14px; vertical-align: top;'>
                                            ...
                                            <p>Hiện tại ngân sách dự toán&nbsp;"{{$plan_name}}"&nbsp;đã được CFO phê duyệt.
                                            </p>
                                            <p>Kính nhờ Anh/Chị vào kiểm tra lại yêu cầu ngân sách trên
                                                và chuyển sang bước xử lý tiếp theo.
                                            </p>

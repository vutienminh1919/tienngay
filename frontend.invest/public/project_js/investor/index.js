$(document).ready(function () {
    ...
    $('#btn_add_investor_uq').click(function (event) {
        event.preventDefault();
        var phone = $("input[name='phone_investor']").val()
        var email = $("input[name='email_investor']").val()
        ...
        $.ajax({
            url: window.origin + '/user/tao_moi_ndt_uy_quyen',
            type: "POST",
            data: formData,
            dataType: 'json',
            headers: {
    ...
    $('#hinh_thuc_uyquyen').change(function () {
        var hinh_thuc_tra_lai = $("select[name='hinh_thuc_tra_lai']").val()
        console.log(hinh_thuc_tra_lai)
    ...
    $('.btn_click_them_moi').click(function () {
        $('.full_name').val('')
        $('.phone').val('')
        $('.cmt').val('')
        $('.email').val('')

        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <form method="post" action="{{ route('menu_create_post') }}">
                                @csrf
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-6">
                                        <input type="text"
                                               ...
                                               placeholder="Tên menu" name="name" value="{{ request()->get('name') }}"
                                               autocomplete="off">
                                        @if( isset($error['name']) )
                                    ...
                                    <div class="col-6">
                                        <select type="text" name="parent" class="form-select"
                                            ...
                                            @foreach($parent as $parent_item)
                                                <option
                                                    value="{{ $parent_item['id'] }}" {{ request()->get('parent') ? 'selected' : '' }}>{{ $parent_item['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>

...
@section('page_name','Quản lý menu')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <ol class="breadcrumb" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">Quản lý menu</a></li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <h1 class="d-inline-block">Danh sách Menu</h1>
                            @if(in_array(\App\Service\ActionInterface::THEM_MOI_MENU, $action_global) || $is_admin == 1)
                                <a class="float-right btn btn-primary d-inline-block" href="{{ route('menu_create') }}">
                                ...
                                <table class="table table-vcenter table-nowrap table-striped">
                                    ...
                                    @foreach($data as $item)
                                        @if( !$item['parent'] )
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            ...
                                                            <a class="dropdown-item"
                                                               href="{{ route('menu_update', $item['id']) }}">
                                            ...
                                            @foreach($data as $menu_item_child)
                                                @if( $item['id'] == $menu_item_child['parent'] )
                                                    <tr>
                                                        <td>|-- {{ $menu_item_child['name'] }}</td>
                                                        <td>{{ $menu_item_child['url'] }}</td>
                                                        <td>
                                                            <label
                                                                class="form-check form-switch d-inline-block mb-0 toggle-status"
                                                                data-id="{{ $item['id'] }}">
                                                                <input class="form-check-input"
                                                                       type="checkbox" {{ ($menu_item_child['status'] == 'active') ? 'checked' : '' }}>
                                                            </label>
                                                        </td>
                                                        <td>
                                                            <div class="dropdown">
                                                                <a href="#" data-bs-toggle="dropdown"
                                                                   aria-expanded="false" aria-haspopup="false">
                                                                    <svg
                                                                        style="width: 28px; height: 28px; color: #828282;"
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        class="icon icon-tabler icon-tabler-dots-vertical"
                                                                        width="24" height="24" viewBox="0 0 24 24"
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end"
                                                                    ...
                                                                    @if(in_array(\App\Service\ActionInterface::CAP_NHAT_MENU, $action_global) || $is_admin == 1)
                                                                        <a class="dropdown-item"
                                                                           href="{{ route('menu_update', $menu_item_child['id']) }}">
                                                                            <svg xmlns="http://www.w3.org/2000/svg"

    ...
    <div class="row mb-3">
        <div class="col-12">
            <ol class="breadcrumb" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">Cập nhật Action</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <h1 class="d-inline-block mb-3">Cập nhật Action</h1>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <form method="post" action="{{ route('action_update_post', $id) }}">
                                @csrf
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-6">
                                        <input type="text"
                                               ...
                                               placeholder="Tên Action" name="name" value="{{ $data['name'] }}"
                                               autocomplete="off">
                                        @if( isset($error['name']) )
                                        ...
                                        <select type="text" name="menu" class="form-select" placeholder="Chọn Menu"
                                            ...
                                            @foreach($menu as $menu_item)
                                                @if ($menu_item['parent'] == null)
                                                    <option
                                                        value="{{ $menu_item['id'] }}" {{ $menu_item['id'] === $data['menu_id'] ? 'selected' : '' }}>{{ $menu_item['name'] }}</option>
                                                    @foreach($menu as $menu_child)
                                                        @if ($menu_child['parent'] == $menu_item['id'])
                                                            <option
                                                                value="{{ $menu_child['id'] }}" {{ $menu_child['id'] === $data['menu_id'] ? 'selected' : '' }}>

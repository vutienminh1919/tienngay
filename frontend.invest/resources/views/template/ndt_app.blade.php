                    ...
                    <div class="nav_link_category mb-3 pb-3">
                        <div class="row">
                            <div class="col-sm-8">
                                <ul class="nav">
                                    <li class="nav_items">
                                        <a class="nav_links active" href="ndt_app" title="">Nhà đầu tư app</a>
                                    </li>
                                    <li class="nav_items">
                                        <a class="nav_links" href="ndt_uyquyen" title="">Nhà đầu tư uỷ quyền</a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <th><a class="" href="#" data-bs-toggle="dropdown" style="color: #000">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="details_uyquyen">Xem chi tiết</a>
                                            </div></th>
                                    </tr>
                                    <tr>
                                        <th>2</th>

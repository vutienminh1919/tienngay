...
@section('page_name','Thêm mới event')
@section('content')
    <div class="row mb-3">
        <div class="col-12">
            <ol class="breadcrumb" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href=""
                                                                   class="text-info">Thêm mới event</a></li>
            </ol>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="card" style="border-radius: 10px">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    <h1 class="d-inline-block">Thêm mới event</h1>
                                    {{-- Search --}}
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <select class="form-control repeat" type="text"
                                                        ...
                                                        @foreach(event_repeat() as $er => $r)
                                                            <option value="{{$er}}">{{$r}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="mb-3 col-md-4 div-month" style="display: none">
                                                ...
                                                <div class="mb-3 col-md-4 div-day" style="display: none">
                                                ...
                                                <div class="mb-3 col-md-4 div-date" style="display: none">
                                                ...
                                                <div class="mb-3 col-md-4 div-hour" style="display: none">
                                            ...
                                            <div class="float-right">
                                                <button class="btn btn-primary btn-add-event">Thêm mới</button>

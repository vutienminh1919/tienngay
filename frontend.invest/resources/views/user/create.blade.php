...
@section('page_name','Tạo tài khoản')
    ...
    <div class="row mb-3">
        <div class="col-12">
            <ol class="breadcrumb" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">Tạo tài khoản</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <h1 class="d-inline-block mb-3">Thêm mới người dùng</h1>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <form method="post" action="{{ route('user_create_post') }}">
                                @csrf
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-6">
                                        <input type="email"
                                               ...
                                               value="{{ request()->get('email') }}" autocomplete="off">
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-6">
                                        <input type="text"
                                               ...
                                               value="{{ request()->get('full_name') }}" autocomplete="off">
                                ...
                                <div class="form-group mb-3 row">
                                    <label class="form-label col-3 col-form-label text-right">Mật khẩu <span
                                            class="text-danger">*</span></label>
                                    <div class="col-6">
                                        <input type="password"
                                               class="form-control {{ isset($error['password']) ? 'is-invalid' : '' }}"
                                               placeholder="Mật khẩu" name="password" autocomplete="new-password"
                                               value="{{ request()->get('password') }}" autocomplete="off">
                                                    ...
                                                    <td>
                                                        <label class="form-check mb-2">
                                                            <input class="form-check-input"
                                                                   data-id="{{ $menu_detail['id'] }}" data-action="0"
                                                                   type="checkbox">
                        ...
                        if (menu_list.id === data_item.menu) {
                            ...
                            action_list.map((action_item) => {
                                data_item.action.map((data_action_item) => {
                                    if (data_action_item == 0) {
                                        str_action += "<span data-action='0'>Xem</span><br>";
                                    }

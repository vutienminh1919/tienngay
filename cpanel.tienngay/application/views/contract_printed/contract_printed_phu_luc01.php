...
việc: Điều chỉnh thông tin số tiền vay</span></i></b></p>
	...
	<p class=MsoNormal align=center style='margin-bottom:0in;text-align:center'><b><i><span
						style='font-size:10.0pt;line-height:107%;font-family:"Times New Roman",serif'>&nbsp;</span></i></b>
	</p>
...
"Times New Roman",serif'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Căn cứ nhu cầu, khả năng của các bên.</span></i></p>
  ...
  height:582.7pt'>
				<p class=MsoNormal style='margin-bottom:3.0pt;line-height:normal'><span
						...
						?> năm <?= $mydate['year'] ?>, tại <?= ($contract->store->address) ? $contract->store->address : '………………………………………' ?></span>
				</p>
				<p class=MsoNormal style='margin-bottom:3.0pt;line-height:normal'><span
    ...
    height:12.5pt'>
							<p class=MsoNormal style='margin-bottom:0in;line-height:normal'><b><span
											style='font-size:11.0pt;font-family:"Times New Roman",serif'>Bên Vay:</span></b>
							</p>
						</td>
    ...
    height:12.5pt'>
							<p class=MsoNormal style='margin-bottom:0in;line-height:normal'><b><span
											style='font-size:11.0pt;font-family:"Times New Roman",serif'>Bên Cho Vay:</span></b>
							</p>
						</td>
    ...
    height:12.5pt'>
							<p class=MsoNormal style='margin-bottom:0in;line-height:normal'><span
										style='font-size:10.0pt;font-family:"Times New Roman",serif'>Họ và tên</span>
							</p>
						</td>
						<td width=210 valign=top style='width:157.5pt;padding:0in 5.4pt 0in 5.4pt;
    height:12.5pt'>
    ...
    0in;margin-left:-2.4pt;text-indent:-.05in;line-height:normal'><span
										style='font-size:10.0pt;font-family:"Times New Roman",serif'>Ngày sinh</span>
							</p>
						</td>
						<td width=209 valign=top style='width:156.55pt;padding:0in 5.4pt 0in 5.4pt;
    height:12.5pt'>
    ...
    height:16.3pt'>
							<p class=MsoNormal style='margin-bottom:0in;line-height:normal'><span
										style='font-size:10.0pt;font-family:"Times New Roman",serif'>: <?= ($address) ? $address : '………………………………………' ?></span>
							</p>
						</td>
						<td width=163 valign=top style='width:122.45pt;padding:0in 5.4pt 0in 5.4pt;
    height:16.3pt'>
    ...
    height:16.3pt'>
							<p class=MsoNormal style='margin-top:0in;margin-right:0in;margin-bottom:
    0in;margin-left:-2.4pt;text-indent:-.05in;line-height:normal'><span
										style='font-size:10.0pt;font-family:"Times New Roman",serif'>Tại Ngân hàng</span>
							</p>
						</td>
						<td width=209 valign=top style='width:156.55pt;padding:0in 5.4pt 0in 5.4pt;
    height:16.3pt'>
							<p class=MsoNormal style='margin-bottom:0in;line-height:normal'><span
										style='font-size:10.0pt;font-family:"Times New Roman",serif'>: <?= ($bank_name_nganluong) ? $bank_name_nganluong : '………………………………………………' ?></span>
							</p>
						</td>
						<td width=163 valign=top style='width:122.45pt;padding:0in 5.4pt 0in 5.4pt;
    height:16.3pt'>
							<p class=MsoNormal style='margin-bottom:0in;line-height:normal'><span
										style='font-size:10.0pt;font-family:"Times New Roman",serif'>Chi nhánh</span>
							</p>
						</td>
						<td width=210 valign=top style='width:157.5pt;padding:0in 5.4pt 0in 5.4pt;
    height:16.3pt'>
							<p class=MsoNormal style='margin-bottom:0in;line-height:normal'><span
										style='font-size:10.0pt;font-family:"Times New Roman",serif'>: <?= ($bank_branch) ? $bank_branch : '…………………………' ?></span>
							</p>
						</td>
					</tr>
  ...
  vụ: CÔNG TY CỔ PHẦN CÔNG NGHỆ TIỆN NGAY </span></b></p>
				<p class=MsoNormal style='margin-top:3.0pt;margin-right:0in;margin-bottom:
  ...
  <?= ($contract->store->address) ? $contract->store->address : '………………………………………………………………………………………………………………..……..' ?></span>
				</p>
				<p class=MsoNormal style='margin-top:3.0pt;margin-right:0in;margin-bottom:
  0in;margin-left:0in;text-align:justify;line-height:normal'><span
  ...
  thuận điều chỉnh, bổ sung Thỏa thuận ba bên về việc hỗ trợ tài chính số <?= empty($code_contract) ? '…………………………………………' : $code_contract ?> </span></i>
				</p>
				<p class=MsoNormal style='margin-top:3.0pt;margin-right:0in;margin-bottom:
  0in;margin-left:0in;text-align:justify;line-height:normal'><i><span
								style='font-size:10.0pt;font-family:"Times New Roman",serif'>ký
  ngày <?= date('d', $created_at); ?>/<?= date('m', $created_at); ?>/<?= date('Y', $created_at); ?> (Sau đây gọi là “Thỏa thuận ba bên”) như sau:</span></i>
				</p>
				<p class=MsoNormal style='margin-top:3.0pt;margin-right:0in;margin-bottom:
  0in;margin-left:0in;text-align:justify;line-height:normal'><b><span
  ...
  Nghị Vay: <?= (number_format($amount_money, 0, '.', '.') . ' đ') ? (number_format($amount_money, 0, '.', '.') . ' đ') : '…………………….... …………………..' ?></span>
				</p>
				<p class=MsoNormal style='margin-top:3.0pt;margin-right:0in;margin-bottom:
  0in;margin-left:0in;text-align:justify;line-height:normal'><span
							style='font-size:10.0pt;font-family:"Times New Roman",serif'>(Bằng chữ:  <b
								class="qcont"><?= ($amount_money > 0) ? convert_number_to_words($amount_money) : '………………………………………………….…' ?></b>).”</span>
				</p>
				<p class=MsoNormal style='margin-top:3.0pt;margin-right:0in;margin-bottom:
  0in;margin-left:0in;text-align:justify;line-height:normal'><span
  ...
  …………………………………………………………………………..….………….... …………………………..</span></p>
				<p class=MsoNormal style='margin-top:3.0pt;margin-right:0in;margin-bottom:
  0in;margin-left:0in;text-align:justify;line-height:normal'><span
							style='font-size:10.0pt;font-family:"Times New Roman",serif'>(Bằng chữ: ………………………………………………………………………………..……………………………………….……)</span>
				</p>
				<p class=MsoNormal style='margin-top:3.0pt;margin-right:0in;margin-bottom:
  0in;margin-left:0in;text-align:justify;line-height:normal'><span
  ...
  lãi và các khoản phí (nếu có) hàng tháng theo thông báo cụ thể của TTC”.</span></p>
				<p class=MsoNormal style='margin-top:3.0pt;margin-right:0in;margin-bottom:
  0in;margin-left:0in;text-align:justify;line-height:normal'><span
  ...
  Việt, mỗi bên giữ 01(một) bản, mỗi bản có giá trị pháp lý như nhau.</span></p>
   ...
   margin-right:6.75pt'>
    ...
    height:22.0pt'>
							<p class=MsoNormal align=center style='margin-top:3.0pt;margin-right:0in;
    margin-bottom:0in;margin-left:0in;text-align:center;line-height:normal'><b><span
											style='font-size:11.0pt;font-family:"Times New Roman",serif'>ĐẠI DIỆN TTC</span></b>
							</p>
						</td>
					</tr>
				</table>

        ...
        <div class="row ">
            ...
            <div class="col-12">
                <p>
                    <i> - Căn cứ Thỏa thuận ba bên số:
                        ...
                        ký ngày <?= !empty($contract->disbursement_date) ? date('d/m/Y', intval($contract->disbursement_date) + 7 * 60 * 60) : '...............................' ?>
                        ;</i>
                </p>
                <p>
            ...
            <div class="col-12">
                <p><i>Hôm nay, ngày <?php
                    ...
                    dịch: <?= ($contract->store->address) ? $contract->store->address : '………………………………………………………………' ?></i></p>
            ...
            <div class="col-12 mb-3">
                <p>
                    Bên B theo chỉ định của Bên cho Vay, giữ tài sản và giấy tờ nêu trên với mục đích làm căn cứ bảo đảm cho nghĩa vụ thanh toán của Bên A đối với Số Tiền Vay theo Thỏa thuận ba bên số
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p>Riêng <?= ($hinh_thuc_su_dung_rieng) ? $hinh_thuc_su_dung_rieng : '……...'; ?>m2;</p>
                            ...
                            <p>Tài sản khác gắn liền với đất: <?= ($tai_san_khac) ? $tai_san_khac : '……………..………'; ?></p>
            ...
            <div class="col-12 mb-3">
                Biên bản bàn giao tài sản này có hiệu lực kể từ ngày ký. Biên bản bàn giao tài sản này được lập thành 02 (hai) bản có giá trị pháp lý như nhau, Bên A và Bên B giữ 01 (một) bản.
            </div>

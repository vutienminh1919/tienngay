	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-12">
				...
				<p><b>Bên cung cấp dịch vụ: CÔNG TY CỔ PHẦN CÔNG NGHỆ TIỆN NGAY</b>
				</p>

				<p>Địa chỉ trụ sở chính: Tầng 15, Khối B, Tòa nhà Sông Đà, đường Phạm Hùng, Phường Mỹ Đình 1, Quận Nam Từ Liêm, thành phố Hà Nội.</p>
				...
				<p>Sau đây gọi tắt là <strong>“TTC”</strong>
				</p>
			...
			<div class="col-5">
				...
				<ol style="list-style: none;">
					<li>2.1. Phí trả nợ trước hạn: Theo thông báo của TTC tại từng thời điểm.
					</li>
					<li>2.2. Phí quản lý số tiền vay chậm trả: Theo thông báo của TTC tại từng thời điểm.</li>
					<li>2.3. Phí tư vấn gia hạn số tiền vay: Theo thông báo của TTC tại từng thời điểm.</li>
					<li>2.4. Phí tư vấn quản lý: Theo thông báo của TTC tại từng thời điểm.</li>
				</ol>
				<p style="margin-top: 10px;">
				...
				<p>
					<b>
						-   Chủ tài khoản: CTCP Công nghệ Tài chính Việt
					</b>
				</p>
				<p>
					<b>
			...
			<div class="col-7">
						...
						<td>
							...
							<ul>
								<li>
									...
									<br>
									<span> TTC - được ưu tiên thanh toán trước tiền bảo hiểm bằng tổng khoản phí tư vấn quản lý chưa thanh toán còn lại của Thỏa Thuận vay.</span>
								</li>
								<li>
									<b><span>Người thụ hưởng thứ II:</span></b>
									<br>
									<span>
										Bên Cho Vay - được ưu tiên thanh toán trước tiền bảo hiểm bằng tổng dư nợ còn lại theo Thỏa Thuận vay nhưng không quá số tiền bảo hiểm sau khi trừ đi phần đã thanh toán cho TTC.
									</span>
								</li>
								<li>
									...
									<br>
									<span>
										Người được bảo hiểm hoặc Người thừa kế hợp pháp – được thanh toán số tiền bảo hiểm còn lại sau khi trừ đi phần đã thanh toán cho TTC và Bên Cho Vay.
									</span>
								</li>
							</ul>
							<p>
				...
				<p>
						...
						Bên Vay cam kết rằng những kê khai là đầy đủ và trung thực. Bên Vay đang trong tình trạng sức khỏe bình thường, không đang trong quá trình điều trị bất kỳ bệnh tật nào, không có bệnh có sẵn, bệnh đặc biệt. Trường hợp, mắc bệnh bẩm sinh, khuyết tật, thương tật, thần kinh, động kinh, phong cùi, HIV hoặc đã từng mắc/đang điều trị các bệnh ung thư, u, bướu, cao/hạ huyết áp, các bệnh về tim mạch, các bệnh mạch máu não, đột quỵ, viêm gan, xơ gan, suy gan, suy tủy lao/suy phổi/tràn khí phổi, bệnh đái tháo đường, viêm thận, suy thận/tụy mãn tính, Parkinson, Lupus ban đỏ, Bên vay có trách nhiệm thông báo với Bên cho vay, TTC và Bên Bảo Hiểm để Bên Bảo Hiểm xem xét nhận bảo hiểm.</span>
				</p>
			...
			<div class="col-4">
				<p class=" text-center"><strong>ĐẠI DIỆN TTC</strong>
				</p>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-12">
				<div class="dieukhoan">
					...
					<p>
						Các Bên đồng ý rằng, dựa trên sự tư vấn của TTC, Bên Cho Vay cho Bên Vay vay Số Tiền Vay. Bên Vay đồng ý đồng thời mua bảo hiểm liên quan đến Khoản Vay của Bên Bảo Hiểm thông qua TTC với quy định cụ thể tại Thỏa Thuận này. Theo đó, mối quan hệ độc lập giữa hai trong Các Bên tại Thỏa Thuận này được thể hiện như sau:
					</p>
					<p>
					...
					<p>
						1.2. Bên Vay chỉ định sử dụng Dịch Vụ Tư Vấn Quản Lý của TTC theo quy định chi tiết tại Mục III Điều Khoản Chung này.
					</p>
					<p>
						1.3. Bên Cho Vay chỉ định TTC đại diện Bên Cho Vay nhận, bảo quản hồ sơ vay từ Bên Vay. Thỏa thuận về việc hợp tác này chi tiết tại hợp đồng hợp tác giữa hai bên.
					</p>
					<p class="p-0">
					...
					<p>
						<span>2.3.</span>
						<span>Nghĩa vụ thanh toán: Bên Vay có nghĩa vụ thanh toán đầy đủ Số Tiền Phải Thanh Toán cho Bên Cho Vay thông qua TTC (theo chỉ định của Bên Cho Vay). Bên Vay thanh toán theo tờ Hướng dẫn thanh toán đính kèm Thỏa Thuận này.
                    </span>
					</p>
					<p>
						<span>2.4.</span>
						<span>Gia hạn Số Tiền Vay: Trường hợp Bên Vay muốn gia hạn Số Tiền Vay thì Bên Vay phải gửi đề nghị gia hạn cho TTC để TTC thông báo cho Bên Cho Vay. Số Tiền Vay chỉ được gia hạn khi có sự chấp thuận bằng Thông Báo đến Bên Vay của Bên Cho Vay.
                    </span>
					</p>
					<p>
						<span>2.5.</span>
					...
					<p>
						<span>4. 6.</span>
						<span>Bên vay đồng ý cho Bên cho vay và/hoặc TTC tìm kiếm, xác minh, cung cấp thông tin liên quan đến bên vay và khoản vay cho bên thứ ba theo quy định của Bên cho vay và/hoặc TTC.</span>
					</p>
					<p>
						<span>4. 7.</span>
						<span>Trường hợp Bên vay không tiếp tục thực hiện công việc nêu tại Mục IV Thỏa thuận này, Bên vay sẽ báo trước cho cho bên vay và/hoặc TTC trước………ngày làm việc và cam kết cùng gia đình sử dụng mọi nguồn thu nhập, tài sản của Bên vay, gia đình để thực hiện nghĩa vụ theo quy định của thỏa thuận này.</span>
					</p>
					<p>
						<span>4. 8.</span>
						<span>Sử dụng tiền vay đúng mục đích, hợp pháp, trả đầy đủ, đúng hạn số tiền gốc, lãi, phí dịch vụ quản lý, bảo hiểm (nếu có) cho Bên cho vay và TTC</span>
					</p>
					<p>
						<span>4. 9.</span>
						<span>Bên vay cam kết đã đọc rõ toàn bộ nội dung văn bản, trong trường hợp Bên vay vi phạm bất kỳ điều khoản nào quy định trong thỏa thuận này, Bên vay chịu trách nhiệm trước pháp luật, Bên cho vay và TTC.</span>
					</p>
					<p class="p-0">
						<b>
							<br>
...
Ngay khi và sau khi xảy ra một Sự Kiện Vi Phạm (bao gồm nhưng không giới hạn: chậm thực hiện, thực hiện không đúng, không đầy đủ nghĩa vụ thanh toán,…) được quy định tại Thỏa Thuận này TTC  có toàn quyền xử lý Tài Sản Bảo Đảm theo quy định của pháp luật (như Tự bán tài sản bảo đảm,...) để trừ vào Số Tiền Phải Thanh Toán của Bên Vay.
</span>
					</p>
					<p class="p-0">
					...
					<p class="p-0">
						<b><span>MỤC III. THỎA THUẬN GIỮA BÊN VAY VÀ TTC</span></b>
					</p>
					<p class="p-0">
					...
					<p>
						<span>8.1.</span>
						<span>Bên Vay chỉ định và TTC đồng ý cung cấp Dịch Vụ Tư Vấn Quản Lý với nội dung cụ thể của Dịch Vụ như sau:
                            </span>
					</p>
					<p>
						<span>a</span>
					...
					<p>
						<span>d</span>
						<span>Các dịch vụ khác theo thỏa thuận giữa Bên Vay và TTC nếu Bên Vay có nhu cầu.
                            </span>
					</p>
					<p>
						<span>8.2.</span>
						<span>Bên Vay sẽ thanh toán Phí Tư Vấn Quản Lý, Phí Quản Lý Số Tiền Vay Chậm Trả (nếu có) cho TTC theo quy định tại Thỏa Thuận này và chính sách cụ thể của TTC.
                    </span>
					</p>
					...
					<p>
						<span>9.1.</span>
						<span>Phí Tư Vấn Quản Lý đối với Số Tiền Vay được quy định tại Thỏa Thuận này đã bao gồm VAT. Bên Vay và TTC đồng ý rằng Phí Tư Vấn Quản Lý cụ thể sẽ được quy định cụ thể tại Thông Báo Đến Bên Vay theo chính sách phí do TTC áp dụng tại từng thời điểm.</span>
					</p>
					<p>
						<span>9.2.</span>
					...
					<p>
						<span>9.3.</span>
						<span>Thanh toán Phí Tư Vấn Quản Lý: Bên Vay thanh toán Phí Tư Vấn Quản Lý hàng tháng cho TTC. Phí Tư Vấn Quản Lý sẽ được TTC tính vào Số Tiền Phải Thanh Toán của Bên Vay hàng tháng và Bên Vay sẽ tiến hành thanh toán vào ngày được nêu tại Thông Báo của TTC.
                    </span>
					</p>
					<p>
						<span>9.4.</span>
					...
					<p>
						<span>10.1.</span>
						<span>Bên Vay sau đây đồng ý TTC là đại lý của Bên Bảo Hiểm, TTC có nghĩa vụ: (a) Tư vấn cho Bên Vay sản phẩm bảo hiểm, Phí Bảo Hiểm, các thông tin liên quan; (b) Hỗ trợ Bên Vay chuẩn bị hồ sơ bảo hiểm và thu, nộp Phí Bảo Hiểm cho Bên Bảo Hiểm; (c) Các công việc khác theo quy định của pháp luật thuộc nghĩa vụ của đại lý bảo hiểm cũng như thỏa thuận giữa TTC và Bên Bảo Hiểm.
                    </span>
					</p>
					<p>
						<span>10.2.</span>
						<span>Phí Bảo Hiểm được xác định tại Ngày Giải Ngân. Bên Vay chỉ định TTC được quyền khấu trừ khoản Phí Bảo Hiểm tương ứng với Số Tiền Vay để thanh toán cho Bên Bảo Hiểm ngay tại thời điểm Giải ngân Khoản Vay.</span>
					</p>
					<p class="p-0">
					...
					<p>
						<span>11.2.</span>
						<span>Thông Báo là phần không thể tách rời của Thỏa Thuận này. Trong trường hợp Thông Báo vì lý do nào đó có một hoặc một vài thông tin bị lỗi và/hoặc sai sót, TTC và/hoặc Bên Cho Vay được quyền đính chính, chỉnh sửa thông tin đó bằng việc gửi một Thông Báo khác đến Bên Vay.
                    </span>
					</p>
					<p>
					...
					<p>
						<span>14.1. </span>
						<span>TTC được quyền gửi thông báo tới khách hàng đã và đang sử dụng dịch vụ của TTC thông tin về sản phẩm hay bất kể dịch vụ nào của TTC thông qua các phương tiện truyền tải thông tin, bao gồm nhưng không giới hạn: tin nhắn, cuộc gọi, thư điện tử,…trong khung giờ từ 08 giờ 00 tới 21 giờ 00 hàng ngày.
                    </span>
					</p>
					<p>
						<span>14.2. </span>
						<span>Bên Vay cam kết và thừa nhận rằng bất kỳ thông tin nào do Bên Vay cung cấp trong quá trình giao kết và thực hiện Thỏa Thuận là chính xác, trung thực. Bên Vay có trách nhiệm thông báo cho Bên Cho Vay và TTC ngay khi có thay đổi về bất kỳ thông tin nào của Bên Vay.</span>
					</p>
					<p>
						<span>14.3.</span>
						<span>Bên Vay bằng văn bản này đồng ý và cho phép Bên Cho Vay và/hoặc TTC được sử dụng, mã hóa, truyền tải, lưu trữ; chuyển giao và tiết lộ bất cứ thông tin nào liên quan đến Bên Vay và/hoặc do Bên Vay cung cấp và/hoặc vấn đề, tài liệu liên quan đến Thỏa Thuận này cho bất kỳ bên thứ ba nào tại bất cứ thời điểm nào mà Bên Cho Vay và/hoặc TTC cho là phù hợp và cần thiết trong phạm vi pháp luật cho phép mà không phải có thêm một sự chấp thuận nào khác của Bên Vay, đồng thời không phải chịu trách nhiệm với Bên Vay liên quan đến các hành vi này.</span>
					</p>
					<p>
						<span>14.4.</span>
						<span>Toàn bộ các quyền, nghĩa vụ của TTC và Bên cho vay được hai bên đảm bảo thực thiện theo quy định chi tiết tại Hợp đồng hợp tác giữa hai bên.
                    </span>
					</p>
					<p>
						<span>14.5.</span>
		...
		<div class="row justify-content-center hidden" style="display: none;">
			...
			<div class="col-12 text-center mb-3">
				...
				<p align=center style='margin:0in;margin-bottom:.0001pt;text-align:center'><b><span
							style='font-size:28pt;color:black'>HƯỚNG DẪN THANH TOÁN TTC</span></b>
				</p>
				...
				<p class=MsoNormal style='text-align:justify;line-height:22.5pt'><span lang=VI style='font-size:17pt;font-family:"Times New Roman",serif;color:#212529'>Chủ
																					Tài Khoản:  <b>Công Ty Cổ Phần Công Nghệ Tiện Ngay</b> (TTC)</span>
				</p>

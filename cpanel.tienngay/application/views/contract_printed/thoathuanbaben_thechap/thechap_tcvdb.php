...
<section>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-4">
				<p class=" text-center"><strong>ĐẠI DIỆN ĐÔNG BẮC</strong>
				</p>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-12">
				<div class="dieukhoan">
					...
					<p>
						Các Bên đồng ý rằng, dựa trên sự tư vấn của Đông Bắc, Bên Cho Vay cho Bên Vay vay Số Tiền Vay. Bên Vay đồng ý đồng thời mua bảo hiểm liên quan đến Khoản Vay của Bên Bảo Hiểm thông qua Đông Bắc với quy định cụ thể tại Thỏa Thuận này. Theo đó, mối quan hệ độc lập giữa hai trong Các Bên tại Thỏa Thuận này được thể hiện như sau:
					</p>
					<p>
					...
					<p>
						1.2. Bên Vay chỉ định sử dụng Dịch Vụ Tư Vấn Quản Lý của Đông Bắc theo quy định chi tiết tại Mục III Điều Khoản Chung này.
					</p>
					<p>
						1.3. Bên Cho Vay chỉ định Đông Bắc đại diện Bên Cho Vay nhận, bảo quản hồ sơ vay từ Bên Vay. Thỏa thuận về việc hợp tác này chi tiết tại hợp đồng hợp tác giữa hai bên.
					</p>
					<p class="p-0">
					...
					<p>
						<span>4. 6.</span>
						<span>Bên vay đồng ý cho Bên cho vay và/hoặc Đông Bắc tìm kiếm, xác minh, cung cấp thông tin liên quan đến bên vay và khoản vay cho bên thứ ba theo quy định của Bên cho vay và/hoặc Đông Bắc.</span>
					</p>
					<p>
						<span>4. 7.</span>
					...
					<p>
						<span>4. 8.</span>
						<span>Sử dụng tiền vay đúng mục đích, hợp pháp, trả đầy đủ, đúng hạn số tiền gốc, lãi, phí dịch vụ quản lý, bảo hiểm (nếu có) cho Bên cho vay và Đông Bắc</span>
					</p>
					<p>
						<span>4. 9.</span>
						<span>Bên vay cam kết đã đọc rõ toàn bộ nội dung văn bản, trong trường hợp Bên vay vi phạm bất kỳ điều khoản nào quy định trong thỏa thuận này, Bên vay chịu trách nhiệm trước pháp luật, Bên cho vay và Đông Bắc.</span>
					</p>
					<p class="p-0">
						<b>
							<br>
...
Ngay khi và sau khi xảy ra một Sự Kiện Vi Phạm (bao gồm nhưng không giới hạn: chậm thực hiện, thực hiện không đúng, không đầy đủ nghĩa vụ thanh toán,…) được quy định tại Thỏa Thuận này Đông Bắc  có toàn quyền xử lý Tài Sản Bảo Đảm theo quy định của pháp luật (như Tự bán tài sản bảo đảm,...) để trừ vào Số Tiền Phải Thanh Toán của Bên Vay.
					...
					<p class="p-0">
						<b><span>MỤC III. THỎA THUẬN GIỮA BÊN VAY VÀ ĐÔNG BẮC</span></b>
					</p>
					<p class="p-0">

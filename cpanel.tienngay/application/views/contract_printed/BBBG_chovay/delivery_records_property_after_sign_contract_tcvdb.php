	...
	<div class="container">
		<div class="row ">
			...
			<div class="col-12 mb-3" style="padding-left:8px;">
				<table class="table table-sm table-borderless">
					...
					<tr>
						...
						<th scope="col" colspan="7">CÔNG TY CỔ PHẦN CÔNG NGHỆ TIỆN NGAY ĐÔNG BẮC</th>
					</tr>
					</thead>
					<tbody>
					<tr>
			...
			<div class="col-12 mb-3">
				...
				<p> 3. Các giấy tờ của Tài Sản Đảm Bảo được Bên Vay bàn giao cho Công Ty Đông Bắc (giấy tờ gốc):</p>
			...
			<div class="col-12 mb-3">
				...
				<p>Bên B theo chỉ định của Bên cho Vay, giữ tài sản và giấy tờ nêu trên với mục đích làm căn cứ bảo đảm

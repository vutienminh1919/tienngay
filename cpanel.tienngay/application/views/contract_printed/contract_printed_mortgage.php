			...
			<div class="col-6">
				...
				<ol>
					...
					<li>
						...
						có) hàng tháng theo thông báo cụ thể của VFC
					</li>
					<li>
		...
		<div class="row">
			...
			<div class="col-12">
				<div class="dieukhoan">
					...
					<p>
						<span>1.9.</span>
						<span>“Phí Thẩm Định”: Là khoản phí Bên Vay phải trả cho VFC theo thông báo của VFC tùy từng thời điểm.</span>
					</p>
					<p>
						<span>1.10.</span>
						<span>
					...
					<p>
						<span>2.3.</span>
						<span>
                    Bên Cho Vay chỉ định VFC đại diện Bên Cho Vay nhận, bảo quản hồ sơ vay từ Bên Vay. Thỏa thuận về việc hợp tác này chi tiết tại hợp đồng hợp tác giữa hai bên.
                  </span>
					</p>
					<p class="p-0">
					...
					<p>
						<span>5.6.</span>
						<span>
                    Bên vay đồng ý cho Bên cho vay và/hoặc VFC tìm kiếm, xác minh, cung cấp thông tin liên quan đến bên vay và khoản vay cho bên thứ ba theo quy định của Bên cho vay và/hoặc VFC.
                  </span>
					</p>
					<p>
						<span>5.7.</span>
						<span>
                    Trường hợp Bên vay không tiếp tục thực hiện công việc nêu tại Mục IV Thỏa thuận này, Bên vay sẽ báo trước cho cho bên vay và/hoặc VFC trước ..... ngày làm việc và cam kết cùng gia đình sử dụng mọi nguồn thu nhập, tài sản của
					...
					<p>
						<span>5.8.</span>
						<span>
                    Sử dụng tiền vay đúng mục đích, hợp pháp, trả đầy đủ, đúng hạn số tiền gốc, lãi, phí dịch vụ quản lý , bảo hiểm (nếu có) cho Bên cho vay và VFC.
                  </span>
					</p>
					<p>
						<span>5.9.</span>
						<span>
                    Bên vay cam kết đã đọc rõ toàn bộ nội dung văn bản, trong trường hợp Bên vay vi phạm bất kỳ điều khoản nào quy định trong thỏa thuận này, Bên vay chịu trách nhiệm trước pháp luật, Bên cho vay và VFC.
                  </span>
					</p>
					<p class="p-0">
					...
					<p>
						<span>8.1. </span>
						<span>
                     Phí Tư Vấn Quản Lý đối với Số Tiền Vay được quy định tại Thỏa Thuận Tài Chính này đã bao gồm VAT. Bên Vay và VFC đồng ý rằng Phí Tư Vấn Quản Lý cụ thể sẽ được quy định cụ thể tại Thông Báo Đến Bên Vay theo chính sách phí do VFC áp dụng tại từng thời điểm.
                  </span>
					</p>
					<p>
						<span>8.2.</span>
					...
					<p>
						<span>  8.3. </span>
						<span>
                   Thanh toán Phí Tư Vấn Quản Lý: Bên Vay thanh toán Phí Tư Vấn Quản Lý hàng tháng cho VFC. Phí Tư Vấn Quản Lý sẽ được VFC tính vào Số Tiền Phải Thanh Toán của Bên Vay hàng tháng và Bên Vay sẽ
                    tiến hành thanh toán vào ngày được nêu tại Thông Báo của VFC.
                  </span>
					</p>
					<p>
						<span>8.4.</span>
					...
					<p>
						<span>9.1.</span>
						<span>
                     Bên Vay sau đây đồng ý VFC là đại lý của Bên Bảo Hiểm, VFC có nghĩa vụ: (a) Tư vấn cho Bên Vay sản phẩm bảo hiểm, Phí Bảo Hiểm, các thông tin liên quan; (b) Hỗ trợ Bên Vay chuẩn bị hồ
                    sơ bảo hiểm và thu, nộp Phí Bảo Hiểm cho Bên Bảo Hiểm; (c) Các công việc khác theo quy định của pháp luật thuộc nghĩa vụ của đại lý bảo hiểm cũng như thỏa thuận giữa VFC và Bên Bảo Hiểm.
                  </span>
					</p>
					<p>
						<span>9.2.</span>
						<span>
                      Phí Bảo Hiểm được xác định tại Ngày Giải Ngân. Bên Vay chỉ định VFC được quyền khấu trừ khoản Phí Bảo Hiểm tương ứng với Số Tiền Vay để thanh toán cho Bên Bảo Hiểm ngay tại thời điểm Giải
                    ngân Khoản Vay.
                  </span>
					</p>
					<p class="p-0">
					...
					<p>
						<span>10.2.</span>
						<span>
                     Thông Báo là phần không thể tách rời của Thỏa Thuận này. Trong trường hợp Thông Báo vì lý do nào đó có một hoặc một vài thông tin bị lỗi và/hoặc sai sót, VFC và/hoặc Bên Cho Vay được quyền
					...
					<p>
						<span>15.1. </span>
						<span>
                     VFC được quyền gửi thông báo tới khách hàng đã và đang sử dụng dịch vụ của VFC thông tin về sản phẩm hay bất kể dịch vụ nào của VFC thông qua các phương tiện truyền tải thông tin, bao gồm nhưng không
					...
					<p>
						<span>15.2.</span>
						<span>
                     Bên Vay cam kết và thừa nhận rằng bất kỳ thông tin nào do Bên Vay cung cấp trong quá trình giao kết và thực hiện Thỏa Thuận là chính xác, trung thực. Bên Vay có trách nhiệm thông báo cho Bên Cho  Vay và VFC ngay khi có thay đổi về bất kỳ thông tin nào của Bên Vay.
                  </span>
					</p>
					<p>
						<span>15.3. </span>
						<span>
                     Bên Vay bằng văn bản này đồng ý và cho phép Bên Cho Vay và/hoặc VFC được sử dụng, mã hóa, truyền tải, lưu trữ; chuyển giao và tiết lộ bất cứ thông tin nào liên quan đến Bên Vay và/hoặc do Bên Vay cung
                    cấp và/hoặc vấn đề, tài liệu liên quan đến Thỏa Thuận này cho bất kỳ bên thứ ba nào tại bất cứ thời điểm nào mà Bên Cho Vay và/hoặc VFC cho là phù hợp và cần thiết trong phạm vi pháp luật cho phép mà không phải có thêm

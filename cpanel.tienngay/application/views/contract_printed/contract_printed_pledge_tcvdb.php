		...
		<div class="row">
			...
			<div class="col-5">
				...
				<ol>
					...
					<li>
						Hình thức giải ngân:
						<span style="padding-left: 30px"><?= ($contract->code_transaction_bank_disbursement != "") ? "&#x2611;" : "☐" ?> Tiền mặt</span><br>
						<span style="padding-left: 149px"><?= ($contract->code_transaction_bank_disbursement == "") ? "&#x2611;" : "☐" ?> Qua số thẻ/tài khoản ngân hàng</span>
					</li>
					<li>
						Thời hạn vay:
						<span style="font-family: 'Segoe UI Symbol', sans-serif;"><?= ($number_day_loan == 1) ? "&#9745;" : "☐" ?></span>
						01 tháng
						...
						09 tháng <br>
						<span style="font-family: 'Segoe UI Symbol', sans-serif; padding-left: 82px"><?= ($number_day_loan == 12) ? "&#9745;" : "☐" ?></span>
						12 tháng
					...
					<li>
						...
						hàng tháng theo thông báo cụ thể của Công Ty Đông Bắc
					</li>
					<li>
			...
			<div class="col-7">
					...
					<tr>
						<td>
							<p>
								...
								<b><span>3. Bảo hiểm Xe máy GIC Easy</span></b>
							</p>
							<p>
								<span>
									Bên Vay thừa nhận quyền và nghĩa vụ của mình theo Thông tư Bảo hiểm Trách nhiệm dân sự bắt buộc của chủ xe cơ giới (truy cập link: <a
											href="https://bit.ly/3uGkX5U"><span style="color: black">https://bit.ly/3uGkX5U</span></a>),
									Quy tắc Tai nạn người ngồi trên xe máy (truy cập link: <a
											href="https://bit.ly/3e2NyeS"><span style="color: black">https://bit.ly/3e2NyeS</span></a>),
									Quy tắc tổn thất, mất cắp, mất cướp toàn bộ xe (truy cập link: <a
				...
				<ol>
					<li>
						Tài Sản Đảm
						Bảo: <?= ($contract->loan_infor->type_property->text) ? $contract->loan_infor->type_property->text : '…………………………………………………' ?>
					</li>
					<li>
						Thông tin Tài Sản Đảm Bảo: <br>

						Số khung: <?= ($sokhung) ? $sokhung : '………………………..' ?>. Số
						máy: <?= ($somay) ? $somay : '……………………' ?><br>

						Biển kiểm soát: <?= ($bienkiemsoat) ? $bienkiemsoat : '……………………' ?>

					</li>
					<li>
						Các giấy tờ của Tài Sản Đảm Bảo được Bên Vay bàn giao cho Công Ty Đông Bắc (giấy tờ gốc):
						Số đăng ký: <?= ($sodangky) ? $sodangky : '………………..…' ?> . Cấp
						ngày: <?= ($dangkycapngay) ? $dangkycapngay : '……………………………' ?>
					</li>
				</ol>
			...
			<div class="col-12">
				<div class="dieukhoan">
					...
					<p>
						<span>1.9.</span>
						<span>
                      “Phí Thẩm Định và Lưu Trữ Tài Sản Đảm Bảo”: Là khoản phí Bên Vay phải trả cho Công Ty Đông Bắc, áp dụng trọng trường hợp có Tài Sản Đảm Bảo và Công Ty Đông Bắc được Bên Cho Vay chỉ định nhận, quản lý và bảo quản Tài Sản Đảm Bảo.
                    </span>
					</p>
					<p>
						<span>1.10.</span>
					...
					<p>
						<span>2.3.</span>
						<span>
                      Bên Cho Vay chỉ định Công Ty Đông Bắc đại diện Bên Cho Vay nhận, bảo quản Tài Sản Đảm Bảo (nếu có) và các giấy tờ liên quan đến Tài Sản Đảm Bảo từ Bên Vay. Thỏa thuận về việc hợp tác này chi tiết tại hợp đồng hợp tác giữa hai bên.
                    </span>
					</p>
					<p class="p-0">
                    ...
                    <ins cite="mailto:LAN" datetime="2020-10-14T22:38"> </ins>Công Ty Đông Bắc có toàn quyền xử lý Tài Sản Đảm Bảo theo quy định của pháp luật
					...
					<p>
						<span>10.1.</span>
						<span>
                      Phí Tư Vấn Quản Lý đối với Số Tiền Vay được quy định tại Thỏa Thuận này đã bao gồm VAT. Bên Vay và Công Ty Đông Bắc đồng ý rằng Phí Tư Vấn Quản Lý cụ thể sẽ được quy định cụ thể tại Thông Báo Đến Bên Vay theo chính sách phí do Công Ty Đông Bắc áp
					...
					<p>
						<span>10.3.</span>
						<span>
                      Thanh toán Phí Tư Vấn Quản Lý: Bên Vay thanh toán Phí Tư Vấn Quản Lý hàng tháng cho Công Ty Đông Bắc. Phí Tư Vấn Quản Lý sẽ được Công Ty Đông Bắc tính vào Số Tiền Phải Thanh Toán của Bên Vay hàng tháng và Bên Vay sẽ tiến hành thanh toán vào ngày
                      được nêu tại Thông Báo của Công Ty Đông Bắc.
                    </span>
					</p>
					<p>
						<span>10.4.</span>
					...
					<p>
						<span>11.1.</span>
						<span>
                      Bên Vay sau đây đồng ý Công Ty Đông Bắc là đại lý của Bên Bảo Hiểm, Công Ty Đông Bắc có nghĩa vụ: (a) Tư vấn cho Bên Vay sản phẩm bảo hiểm, Phí Bảo Hiểm, các thông tin liên quan; (b) Hỗ trợ Bên Vay chuẩn bị hồ sơ bảo hiểm và thu, nộp Phí Bảo Hiểm cho Bên Bảo Hiểm; (c) Các công việc khác theo quy định của pháp luật thuộc nghĩa vụ của đại lý bảo hiểm cũng như thỏa thuận giữa Công Ty Đông Bắc và Bên Bảo Hiểm.
                    </span>
					</p>
					<p>
						<span>11.2.</span>
						<span>
                       Phí Bảo Hiểm được xác định tại Ngày Giải Ngân. Bên Vay chỉ định Công Ty Đông Bắc được quyền khấu trừ khoản Phí Bảo Hiểm tương ứng với Số Tiền Vay để thanh toán cho Bên Bảo Hiểm ngay tại thời điểm Giải ngân Khoản Vay.
                    </span>
					</p>
					<p class="p-0">
					...
					<p>
						<span>12.1.</span>
						<span>
                      Trường hợp Bên Vay thực hiện không đúng, không đầy đủ nghĩa vụ thanh toán Số Tiền Vay đối với Bên Cho Vay, Công Ty Đông Bắc chịu trách nhiệm thực hiện nghĩa vụ này nếu hai bên có thỏa thuận mà không cần sự chấp thuận của Bên cho vay.
                    </span>
					</p>
					<p>
						<span>12.2.</span>
						<span>
                       Thỏa thuận giữa Công Ty Đông Bắc và Bên Vay phải lập thành văn bản, được đóng dấu, ký bởi người đại diện hợp pháp của các bên.
                    </span>
					</p>
					<p>
					...
					<p>
						<span>13.2.</span>
						<span>
                      Thông Báo là phần không thể tách rời của Thỏa Thuận này. Trong trường hợp Thông Báo vì lý do nào đó có một hoặc một vài thông tin bị lỗi và/hoặc sai sót, Công Ty Đông Bắc và/hoặc Bên Cho Vay được quyền đính chính, chỉnh sửa thông tin
					...
					<p>
						<span>18.1.</span>
						<span>
                      Công Ty Đông Bắc được quyền gửi thông báo tới khách hàng đã và đang sử dụng dịch vụ của Công Ty Đông Bắc thông tin về sản phẩm hay bất kể dịch vụ nào của Công Ty Đông Bắc thông qua các phương tiện truyền tải thông tin, bao gồm nhưng không giới hạn: tin nhắn,
					...
					<p>
						<span>18.2.</span>
						<span>
                      Bên Vay cam kết và thừa nhận rằng bất kỳ thông tin nào do Bên Vay cung cấp trong quá trình giao kết và thực hiện Thỏa Thuận là chính xác, trung thực. Bên Vay có trách nhiệm thông báo cho Bên Cho Vay và Công Ty Đông Bắc ngay khi có
					...
					<p>
						<span>18.3.</span>
						<span>
                      Bên Vay bằng văn bản này đồng ý và cho phép Bên Cho Vay và/hoặc Công Ty Đông Bắc được sử dụng, mã hóa, truyền tải, lưu trữ; chuyển giao và tiết lộ bất cứ thông tin nào liên quan đến Bên Vay và/hoặc do Bên Vay cung cấp và/hoặc vấn đề,
                      tài liệu liên quan đến Thỏa Thuận này cho bất kỳ bên thứ ba nào tại bất cứ thời điểm nào mà Bên Cho Vay và/hoặc Công Ty Đông Bắc cho là phù hợp và cần thiết trong phạm vi pháp luật cho phép mà không phải có thêm một sự chấp thuận nào
...
<!--																		justify;line-height:normal'><span lang=VI-->
<!--																										  style='font-size:17pt;font-family:-->
<!--																		"Times New Roman",serif'>Chi nhánh: Trung Hòa – Nhân Chính</span>-->
<!--							</p>-->
<!--						</td>-->
<!--					</tr>-->
				</table>

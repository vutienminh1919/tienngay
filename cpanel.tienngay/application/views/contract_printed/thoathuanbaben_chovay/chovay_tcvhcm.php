		...
		<div class="row">
			...
			<div class="col-12">
				<div class="dieukhoan">
					...
					<p>
						<span><b>Điều 1. Mục đích của Thỏa Thuận</b> <br> Các Bên đồng ý rằng, dựa trên sự tư vấn của TTC_CN, Bên Cho Vay cho Bên Vay vay Số Tiền Vay. Bên Vay đồng ý đồng thời mua bảo hiểm liên quan đến Khoản Vay của Bên Bảo Hiểm thông qua TTC_CN với quy định cụ thể tại Thỏa Thuận này. Theo đó, mối quan hệ độc lập giữa hai trong Các Bên tại Thỏa Thuận này được thể hiện như sau:</span>
					</p>
					<p>
						<span>1.1.</span>
					...
					<p>
						<span>1.2.</span>
						<span>Bên Vay chỉ định sử dụng Dịch Vụ Tư Vấn Quản Lý của TTC_CN theo quy định chi tiết tại Mục III Điều Khoản Chung này.</span>
					</p>
					<p>
						<span>1.3.</span>
						<span>Bên Cho Vay chỉ định TTC_CN đại diện Bên Cho Vay: Nhận, bảo quản, xử lý Tài Sản Đảm Bảo (nếu có) và các giấy tờ liên quan đến Tài Sản Đảm Bảo từ Bên Vay. Thỏa thuận về việc hợp tác này chi tiết tại hợp đồng hợp tác giữa hai bên.</span>
					</p>
					<p>
						<span>1.4.</span>
						<span>Bên Vay đồng ý và không hủy ngang trách nhiệm cho TTC_CN lắp đặt thiết bị định vị toàn cầu (GPS) vào Tài Sản Đảm Bảo để quản lý hoạt động của tài sản trong trường hợp vay qua hình thức lắp thiết bị định vị trong suốt thời gian thực hiện Thỏa thuận này. Thiết bị GPS là tài sản thuộc sở hữu của TTC_CN. Theo đó, Bên Vay không phải sử dụng dịch vụ Thẩm định của TTC_CN đã được quy định tại Điều 8 của Thỏa thuận này.</span>
					</p>
					<p class="p-0">
					...
					<p>
						<span>4. 4.</span>
						<span>Trong trường hợp lắp đặt thiết bị định vị toàn cầu (GPS), Bên vay cam kết vô điều kiện và không hủy ngang việc chịu trách nhiệm bồi thường thiệt hại 700.000 VNĐ (Bảy trăm nghìn đồng) cho TTC_CN trong trường hợp phát sinh bất kỳ thiệt hại liên quan đến thiết bị định vị toàn cầu (GPS) là tài sản thuộc sở hữu của TTC_CN.</span>
					</p>
					<p>
						<span>4. 5.</span>
...
Ngay khi và sau khi xảy ra một Sự Kiện Vi Phạm (bao gồm nhưng không giới hạn: chậm thực hiện, thực hiện không đúng, không đầy đủ nghĩa vụ thanh toán,…) được quy định tại Thỏa Thuận này TTC_CN  có toàn quyền xử lý Tài Sản Bảo Đảm theo quy định của pháp luật (như Tự bán tài sản bảo đảm,...) để trừ vào Số Tiền Phải Thanh Toán của Bên Vay.
					...
					<p>
						<span>11.1.</span>
						<span>Trường hợp Bên Vay thực hiện không đúng, không đầy đủ nghĩa vụ thanh toán Số Tiền Vay đối với Bên Cho Vay, TTC_CN chịu trách nhiệm thực hiện nghĩa vụ này nếu hai bên có thỏa thuận mà không cần sự chấp thuận của Bên cho vay.
                    </span>
					</p>
					<p>
						<span>11.2.</span>
						<span>Thỏa thuận giữa TTC_CN và Bên Vay phải lập thành văn bản, được đóng dóng, ký bởi người hai bên hoặc người đại diện hợp pháp của các bên.
                    </span>
					</p>
					<p class="p-0">

  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <form role="form" class="form-horizontal form-label-left">
        <a href="#" class="btn btn-stepwizard-mb btn-warning btn-lg w-100" data-target="step-1">
        ...
        <a href="#" class="btn btn-stepwizard-mb btn-warning btn-lg w-100 disabled" data-target="step-2" disabled>
          Địa chỉ hộ khẩu
        </a>
        ...
        <a href="#" class="btn btn-stepwizard-mb btn-warning btn-lg w-100 disabled" data-target="step-3" disabled>
          Địa chỉ đang ở
        </a>
        ...
        <a href="#" class="btn btn-stepwizard-mb btn-warning btn-lg w-100 disabled" data-target="step-4" disabled>
          Thông tin việc làm
        </a>
        ...
        <a href="#" class="btn btn-stepwizard-mb btn-warning btn-lg w-100 disabled" data-target="step-5" disabled>
        ...
        <a href="#" class="btn btn-stepwizard-mb btn-warning btn-lg w-100 disabled" data-target="step-6" disabled>
          Thông tin khoản vay
        </a>
        ...
        <a href="#" class="btn btn-stepwizard-mb btn-warning btn-lg w-100 disabled" data-target="step-7" disabled>
          Thông tin tài sản
        </a>

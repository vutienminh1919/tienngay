      ...
      <div class="x_panel panel_phonecard" >
        <div class="x_content">
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            ...
            <div role="tabpanel" class="tab-pane active in" id="tab_cardcode" aria-labelledby="tab_cardcode">
              <div class="card-body">
                <ul class="selecttype">
                  <li>
                    <input id="selecttype_cardcode_1" type="radio" name="selecttype">
                    <label for="selecttype_cardcode_1">
                  ...
                  <li>
                    <input id="selecttype_cardcode_2" type="radio" name="selecttype">
                    <label for="selecttype_cardcode_2">
                  ...
                  <li>
                    <input id="selecttype_cardcode_3" type="radio" name="selecttype">
                    <label for="selecttype_cardcode_3">
                  ...
                  <li>
                    <input id="selecttype_cardcode_4" type="radio" name="selecttype">
                    <label for="selecttype_cardcode_4">
                  ...
                  <li>
                    <input id="selecttype_cardcode_5" type="radio" name="selecttype">
                    <label for="selecttype_cardcode_5">
              ...
              <div class="card-body">
                ...
                <div class="row selectmoney">
                  <div class="col-xs-4">
                    <input id="selectmoney_cardcode_20000" type="radio" name="selectmoney">
                    <label for="selectmoney_cardcode_20000" >20.000</label>
                  </div>
                  <div class="col-xs-4">
                    <input id="selectmoney_cardcode_50000" type="radio" name="selectmoney">
                    <label for="selectmoney_cardcode_50000">50.000</label>
                  </div>
                  <div class="col-xs-4">
                    <input id="selectmoney_cardcode_100000" type="radio" name="selectmoney">
                    <label for="selectmoney_cardcode_100000">100.000</label>
                  </div>
                  <div class="col-xs-4">
                    <input id="selectmoney_cardcode_200000" type="radio" name="selectmoney">
                    <label for="selectmoney_cardcode_200000">200.000</label>
                  </div>
                  <div class="col-xs-4">
                    <input id="selectmoney_cardcode_300000" type="radio" name="selectmoney">
              ...
              <div class="card-body">
                ...
                <ul class="information">
                  <li>
                    Số lượng thẻ
                    <span>
                      <input type="number" class="form-group text-right" value="1" min="1" style="max-width:75px">
                    </span>
                  </li>
                  <li>
                    Chiết khấu: 1,5%
    ...
    <div class="modal-content">
      ...
      <div class="card card-phoneresult">
        <div class="card-header">
          ...
          <p class="thephone">Mua mã thẻ điện thoại</p>

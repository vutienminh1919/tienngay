            ...
            <div class="panel panel-default panel-login">
              ...
              <div class="alert alert-danger alert-dismissible fade in">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  <strong>Shiet happen</strong>
              </div>
              <form>
                <div class="form-group">
                  <i class="fa fa-lock"></i>
                  <input id="thepasswords1" type="password" class="form-control" placeholder="Type your new passwords">
                ...
                <div class="form-group" >
                  <i class="fa fa-lock"></i>
                  <input id="thepasswords2" type="password" class="form-control" placeholder="Type your new passwords again">

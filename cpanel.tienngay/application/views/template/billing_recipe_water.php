        ...
        <div class="x_content">
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab1" class="nav nav-tabs " role="tablist">
              <li role="presentation" ><a href="#" ><i class="fa fa-bolt" aria-hidden="true"></i> Điện EVN</a>
              </li>
              <li role="presentation" class="active"><a href="#" ><i class="fa fa-tint" aria-hidden="true"></i> Nước</a>
              </li>
              <li role="presentation" class=""><a href="#" ><i class="fa fa-money" aria-hidden="true"></i> Tài chính</a>
              </li>
            </ul>
                ...
                <div class="card-body">
                  <div class="container">
                    ...
                    <div class="setup-content" id="step-1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="btn-group icon-select w-100 bg-transparent">
                          <a class="btn dropdown-toggle btn btn-default w-100" data-toggle="dropdown" href="#" style="text-align:left !important">
                            <img src="<?php echo base_url();?>assets/imgs/logo/logo_sawaco.png" style="width:24px;margin-right: 5px">Cty Nước Hà Nội
                          </a>
                          <ul class="dropdown-menu" style="width: 100%;">
                            <li> <a href="#"><img src="<?php echo base_url();?>assets/imgs/logo/logo_sawaco.png" style="width:24px;margin-right: 5px">Cty Nước Hà Nội</a> </li>
                            <li> <a href="#"><img src="<?php echo base_url();?>assets/imgs/logo/logo_sawaco.png" style="width:24px;margin-right: 5px">Cty Nước tp HCM</a> </li>
                      ...
                      <div class="form-group">
                        <label class="control-label">Nhập mã khách hàng / Mã danh bộ</label>
                    ...
                    <div class="setup-content" id="step-2">
                      <div class="card card-billing-recipe-result">
                        <div class="card-header">
                          ...
                          <p class="text-1">Cty Nước Hà Nội</p>
                          <p class="text-1"> PA01ND0000889</p>
                          <p class="text-2"> Mã khách hàng</p>
                          <ul>
                            <li>Họ tên
                            ...
                            <li>
                              Địa chỉ
                              <span>Lô A14 Khu CN Hòa Xá Xã Lộc Hòa TP Nam Định T.Nam Định  Việt Nam</span>
                            </li>
                          </ul>
                        </div>
                    ...
                    <div class="setup-content" id="step-3">
                      ...
                      <div class="card card-billing-recipe-result">
                        <div class="card-header">
                          ...
                          <p class="text-1"> PA01ND0000889</p>
                          <p class="text-2">Cong ty TNHH Hoang Long - Kỳ 2019 - 11- 22 đến 2019 - 12 - 21 </p>

            ...
            <div class="panel panel-default panel-login">
              ...
              <div class="alert alert-success alert-dismissible fade in">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  <strong>Mật khẩu được thay đổi thành công</strong>
              </div>
              ...
              <form>
                ...
                <div class="form-group" style="margin-bottom:12px;">
                  ...
                  <input id="thepasswords" type="password" class="form-control" placeholder="Password">
                ...
                <div class="form-group">
                  <p class="thelinks">
                    <span>New to site? <a href="#">Create account</a> </span>

                    <span class="float-right">Forgot password? <a href="#">Reset password</a>  </span>
                  </p>
                </div>

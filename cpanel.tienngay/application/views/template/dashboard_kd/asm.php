				...
				<div class="row">
					<div class="col-xs-8">
						<div class="title">
							...
							<span>ASM: Nội thành Hà Nội</span>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="col-md-8">
								<div class="right_wiget-bar">
									...
									<div class="line_bar_list">
										...
										<div class="item_child" data-toggle="modal" data-target="#kpi">
											<div class="item_bar">
												<span>Khu vực nội thành Hà Nội</span>
						...
						<div class="area_box_wrapper">
							...
							<div class="list-area">
								<ul class="tabs_area tabs_nav_area">
									...
									<li class="" data-tab="area_4">
										Khu vực Bắc Từ Liêm
									</li>
									<li class="" data-tab="area_5">
										Khu vực Bắc Từ Liêm
									</li>
									<li class="" data-tab="area_6">
										Khu vực Bắc Từ Liêm
									</li>
									<li class="" data-tab="area_7">
										Khu vực Bắc Từ Liêm
									</li>
									<li class="" data-tab="area_8">
										Khu vực Bắc Từ Liêm
									</li>
								</ul>
							</div>
					...
					<div class="col-md-8">
							...
							<div id="area_1" class="tab-panels active">
								<div class="infor_area_details">
									<div class="infor_show">
										...
										<div class="name_lead">
											<span>Trưởng phòng: </span>NGYỄN BÁ NGUYÊN
										</div>
									</div>
									<div class="month_kpi_before">
										...
										<div class="block_com_data">
											<table>
												...
												<tr>
													<td>Số tiền hợp đồng quá hạn</td>
													<td style="color: #0E9549">50.000.000</td>
													<td style="color: #EC1E24">69,96%</td>
												</tr>
												</tbody>
						...
						<div class="month_kpi_after">
							...
							<div class="form">
								...
								<div class="input-group">
									<label>Số tiền hợp đồng quá hạn<span style="color: red">*</span></label>
									<div class="form-group">
										<input type="text" class="form-control" id="money_gn" name="money_gn"

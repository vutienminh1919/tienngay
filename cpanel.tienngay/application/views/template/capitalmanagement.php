    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-horizontal form-label-left">
          ...
          <div class="col-xs-12 col-md-6">
          <div class="x_title">
            <strong><i class="fa fa-money" aria-hidden="true"></i> Thông tin hợp đồng</strong>

            <div class="clearfix"></div>
          </div>

          <div class="form-group">
            <label class="control-label col-lg-4 col-md-3 col-sm-3 col-xs-12">Số tiền đầu tư <span class="text-danger">*</span>
            </label>
            <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group">
          <label class="control-label col-lg-4 col-md-3 col-sm-3 col-xs-12">Ngày góp  <span class="text-danger">*</span>
          </label>
          <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12">
            <select class="form-control" >
              <option>Vốn đầu tư ( không lãi )</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
            </select>

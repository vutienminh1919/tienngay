		...
		<div class="col-xs-12">
			<div class="row">
				<div class="col-xs-12 col-md-6 col-lg-4">
					<div class="x_panel">
						<form class="form-horizontal form-label-left" action="<?php echo base_url("Commission_kpi/createProductType")?>" method="post">
							<div class="x_title">
											...
											if ($item->parent_id == $parent_id) {
												...
												<tr class='property_main_<?= getId($item->_id)?>'>
													...
													<td class="text-right">
														...
														<a  class="btn btn-primary"  href="<?php echo base_url("Commission_kpi/update?id=").getId($item->_id)?>">

					...
					<div class="" role="tabpanel" data-example-id="togglable-tabs">
						...
						<div class="table-responsive" style="overflow-y: auto">
							<table class="table table-bordered m-table table-hover table-calendar table-report ">
								...
								<tr>
									<th style="width:32px"><input type="checkbox" name="all_vbi_utv" value=""
																  id="selectAll"></th>
								...
								<tbody>
								<?php foreach ($vbi_utv as $key => $value) { ?>
									<tr style="text-align: center">
										...
										<td><?php echo number_format($value->fee) . " VND" ?></td>
...
<!-- /page content -->
<script src="<?php echo base_url() ?>assets/js/bao_hiem_vbi/utv/sendKT.js"></script>

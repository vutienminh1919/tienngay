		...
		<div class="col-xs-12">
			<div class="page-title">
				<div class="title_left">
					<h3>Thêm mới bảo hiểm VBI UTV
						<br>
						<small><a href="<?php echo base_url() ?>"><i class="fa fa-home"></i> Home</a> / <a
									href="<?php echo base_url('baoHiemVbi/utv') ?>">Danh sách bảo hiểm VBI UTV</a>
							...
							<div class="panel-body">
								<div class="row">
									...
									<div class="col-xs-12 col-md-4 error_messages">
										<div class="form-group ">
											<label class="control-label">
												CMT người được bảo hiểm <span class="text-danger">*</span>
											</label>
									...
									<div class="col-xs-12 col-md-4 error_messages">
										<div class="form-group ">
											<label class="control-label">
												Ngày cấp CMT người được bảo hiểm <span class="text-danger">*</span>
											</label>
											<input type="date" name="cmt_ngay_cap_nguoi_bh"
												   class="form-control click_vbi"
												   placeholder="Nhập số cmt" required id="cmt_ngay_cap_nguoi_bh">
											<p class="messages"></p>
										</div>
									</div>
									<div class="col-xs-12 col-md-4 error_messages">
										<div class="form-group ">
											<label class="control-label">
												Nơi cấp CMT người được bảo hiểm <span class="text-danger">*</span>
											</label>
											<input type="text" name="cmt_noi_cap_nguoi_bh"
												   class="form-control click_vbi"
												   placeholder="Nhập số cmt" required id="cmt_noi_cap_nguoi_bh">
											<p class="messages"></p>
										</div>
									</div>
									...
									<div class="col-xs-12 col-md-4 error_messages">
										<div class="form-group ">
											...
											<select name="goi_bao_hiem" class="form-control click_vbi"
													id="goi_bao_hiem" >
												<option value="UNG_THU_VU_1">Pinkcare_Lemon</option>
												<option value="UNG_THU_VU_2">Pinkcare_Orange</option>
												<option value="UNG_THU_VU_3">Pinkcare_Pomelo</option>
											</select>
											<p class="messages"></p>
										</div>
									</div>
						...
						<div class="x_content">
							<div class="col-md-12 col-xs-12">
								<div class="" style="text-align: center">
									<button class="btn btn-success ban_bao_hiem_vbi_utv">
										Áp dụng Bán
									</button>
									<a href="<?php echo base_url('baoHiemVbi/utv') ?>" class="btn btn-info ">
...
<!-- /page content -->
<script src="<?php echo base_url(); ?>assets/js/bao_hiem_vbi/utv/form_add.js"></script>

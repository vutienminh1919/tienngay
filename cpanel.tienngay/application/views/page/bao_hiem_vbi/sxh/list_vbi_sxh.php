		...
		<div class="col-xs-12">
			...
			<div class="page-title">
				<div class="title_left">
					<h3>Danh sách thu tiền VBI_SXH</h3>
				</div>
				<div class="title_right text-right">
					<a href="<?php echo base_url() ?>baoHiemVbi/form_vbi_sxh" class="btn btn-info">
						<i class="fa fa-plus" aria-hidden="true"></i>
						Thêm giao dịch
					</a>
					<a href="<?php echo base_url() ?>baoHiemVbi/add_transaction_pay_money_sxh" class="btn btn-success"
					   target="_blank">
					...
					<div class="dropdown" style="display:inline-block">
						...
						<ul id="lockdulieu" class="dropdown-menu dropdown-menu-right"
							...
							<div class="row">
								<form action="<?php echo base_url('baoHiemVbi/sxh') ?>" method="get"
									  style="width: 100%">
					...
					<?php if ($tab != "transaction") {
						if ($userSession['is_superadmin'] == 1 || in_array('van-hanh', $groupRoles) || in_array('hoi-so', $groupRoles) || in_array('ke-toan', $groupRoles) || in_array('quan-ly-khu-vuc', $groupRoles)) { ?>
							<a href="<?php echo base_url() ?>excel/exportVbiSxhBn?<?= 'tab='. $tab . '&fdate=' . $fdate . '&tdate=' . $tdate . '&customer_name=' . $customer_name . '&customer_phone=' . $customer_phone . '&code=' . $code . '&code_gic_plt=' . $code_gic_plt . '&filter_by_store=' . $filter_by_store;?>" class="btn btn-success"
							   target="_blank">
								<i class="fa fa-save" aria-hidden="true"></i>
								Xuất Excel
							</a>
					...
					<div class="row">
						...
						<div class="col-xs-12 text-right">
							<ul id="myTab1" class="nav nav-tabs bar_tabs left" role="tablist">
								<li role="presentation" class="<?= ($tab == 'vbi_sxh') ? 'active' : '' ?>">
									<a href="<?php echo base_url() ?>baoHiemVbi/sxh?tab=vbi_sxh"
									   id="naptientaixeheyu1-tabb"
									   aria-expanded="true"> Giao dịch KH</a>
								</li>
								<li role="presentation" class="<?= ($tab == 'transaction') ? 'active' : '' ?>"><a
											href="<?php echo base_url() ?>baoHiemVbi/sxh?tab=transaction"
				...
				<div class="x_content">
					<div class="" role="tabpanel" data-example-id="togglable-tabs">
						<div id="myTabContent2" class="tab-content">
							<div role="tabpanel" class="tab-pane fade in <?= ($tab == 'vbi_sxh') ? 'active' : '' ?>"
											...
											<?php if (!empty($transaction)) : ?>
												<?php foreach ($transaction as $value) { ?>
													<tr style="text-align: center">
														<td>
															<div class="dropdown">
																...
																<ul class="dropdown-menu"
																	style="z-index: 99999;">
																	<li>
																		<a href="<?php echo base_url() ?>baoHiemVbi/detail_sxh_transaction?code=<?php echo $value->code ?>">Xem
																			chi tiết
																		</a>
																	</li>
																	<?php
														...
														<td><?= !empty($value->code) ? $value->code : "" ?>
															<br>
															<?php
															if ($value->status == 11) { ?>

		...
		<div class="col-xs-12">
			...
			<div class="page-title">
				...
				<div class="title_right text-right">
					<a href="<?php echo base_url() ?>pti_vta/index?tab=transaction" class="btn btn-info">
					...
					<div class="" role="tabpanel" data-example-id="togglable-tabs">
						...
						<div class="table-responsive" style="overflow-y: auto">
							<table class="table table-bordered m-table table-hover table-calendar table-report ">
								...
								<tr>
									<th style="width:32px"><input type="checkbox" name="all_pti_vta" value=""
																  id="selectAll"></th>
								...
								<tbody>
								<?php foreach ($pti_vta as $key => $value) { ?>
									<tr style="text-align: center">
										<th style="width:32px"><input type="checkbox" name="pti_vta[]"
										value="<?php echo $value->pti_code ?>"
																	  class="ptiCheckBox"></th>
										<td><?php echo $value->pti_code ?></td>
...
<!-- /page content -->
<script src="<?php echo base_url() ?>assets/js/pti_vta/sendKT.js"></script>

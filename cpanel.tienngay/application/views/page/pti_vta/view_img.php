		...
		<div class="page-title">
			<div class="title_left">
				<h3>Chứng từ
					<br>
					<small>
						<a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a>/ <a href="<?php echo base_url('pti_vta/list_pti_vta')?>">GIC PLT</a>/ <a href="#">Chứng từ</a>
					</small>
				</h3>
			</div>
			<div class="title_right text-right">
				<a href="<?php echo base_url('pti_vta/list_pti_vta')?>" class="btn btn-info ">
			...
			<div class="x_content">
				<form class="form-horizontal form-label-left">
					<div class="form-group ">
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Chứng từ PTI Vững Tâm An <?php //$this->lang->line('Driver_license_vehicle_registration')?><span class="red">*</span></label>

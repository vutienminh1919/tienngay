		...
		<div class="col-xs-12">
			...
			<div class="page-title">
				...
				<div class="title_right text-right">
					<a class="btn btn-info" href="<?php echo base_url() ?>pti_vta/index?tab=transaction">
					...
					<div class="" role="tabpanel" data-example-id="togglable-tabs">
						...
						<div class="table-responsive">
							<table class="table table-bordered m-table table-hover table-calendar table-report ">
								...
								<tbody>
								<?php foreach ($ptis as $pti) { ?>
									<tr>
										<th><?php echo $pti->customer_info->customer_name ?></th>
										<th><?php echo $pti->customer_info->customer_phone ?></th>
										<th><?php echo number_format($pti->price) . " VND" ?></th>
										<th><?php echo date('d/m/Y H:i:s', $pti->created_at) ?></th>
									</tr>
								<?php } ?>
								</tbody>
							</table>

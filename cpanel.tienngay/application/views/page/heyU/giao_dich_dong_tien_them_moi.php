		...
		<div class="col-xs-12">
			...
			<div class="page-title">
				...
				<div class="title_right text-right">
					<a href="<?php echo base_url() ?>heyU/index?tab=transaction" class="btn btn-info">
					...
					<div class="" role="tabpanel" data-example-id="togglable-tabs">
						...
						<div class="table-responsive" style="overflow-y: auto">
							<table class="table table-bordered m-table table-hover table-calendar table-report ">
								...
								<tr>
									<th style="width:32px"><input type="checkbox" name="all_heyu" value=""
																  id="selectAll"></th>
								...
								<?php foreach ($heyU as $key => $value) { ?>
									<tr style="text-align: center">
										<th style="width:32px"><input type="checkbox" name="heyu[]"
																	  value="<?php echo $value->transaction_code ?>"
																	  class="heyUCheckBox"></th>
										...
										<td><?php if ($value->status == 10) : ?>
											...
											<?php elseif ($value->status == 11) : ?>
												<span class="label label-primary">Kế toán trả về</span>
											<?php elseif ($value->status == 3) : ?>
												<span class="label label-warning">Kế toán yêu cầu tạo lại</span>
											<?php endif; ?>
...
<!-- /page content -->
<script src="<?php echo base_url() ?>assets/js/heyU/sendKT.js"></script>

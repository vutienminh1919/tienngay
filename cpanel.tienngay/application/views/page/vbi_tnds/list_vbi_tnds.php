		...
		<div class="col-xs-12">
			...
			<div class="page-title">
				<div class="title_left">
					<h3>Danh sách thu tiền VBI_TNDS</h3>
				</div>
				<div class="title_right text-right">
					<a href="<?php echo base_url() ?>vbi_tnds/form_vbi_tnds" class="btn btn-info">
						<i class="fa fa-plus" aria-hidden="true"></i>
						Thêm giao dịch
					</a>
					<a href="<?php echo base_url() ?>vbi_tnds/add_transaction_pay_money" class="btn btn-success"
					   target="_blank">
						<i class="fa fa-save" aria-hidden="true"></i>
						Tạo lệnh đóng tiền
					</a>

					<a style="background-color: #18d102;" href="<?=base_url()?>excel/exportListVbiTnds?fdate=<?=$fdate.'&tdate='.$tdate.'&customer_phone='.$customer_phone.'&code='.$code.'&tab='.$tab ?>" class="btn btn-primary" target="_blank"><i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp; Xuất excel</a> 
					...
					<div class="dropdown" style="display:inline-block">
						...
						<ul id="lockdulieu" class="dropdown-menu dropdown-menu-right"
							...
							<div class="row">
								<form action="<?php echo base_url('vbi_tnds') ?>" method="get"
									  style="width: 100%">
					...
					<div class="row">
						...
						<div class="col-xs-12 text-right">
							...
							<ul id="myTab1" class="nav nav-tabs bar_tabs left" role="tablist">
								<li role="presentation" class="<?= ($tab == 'vbi_tnds') ? 'active' : '' ?>">
									<a href="<?php echo base_url() ?>vbi_tnds?tab=vbi_tnds"
									   id="naptientaixeheyu1-tabb"
									   aria-expanded="true"> Giao dịch KH</a>
								</li>
								<li role="presentation" class="<?= ($tab == 'transaction') ? 'active' : '' ?>"><a
											href="<?php echo base_url() ?>vbi_tnds?tab=transaction"
				...
				<div class="x_content">
					<div class="" role="tabpanel" data-example-id="togglable-tabs">
						<div id="myTabContent2" class="tab-content">
							<div role="tabpanel" class="tab-pane fade in <?= ($tab == 'vbi_tnds') ? 'active' : '' ?>"
														...
														<td>
															<div class="dropdown">
																...
																<ul class="dropdown-menu"
																	style="z-index: 99999;">
																	<li>
																		<a href="<?php echo base_url() ?>vbi_tnds/detail_transaction?code=<?php echo $value->code ?>">Xem
																			chi tiết
																		</a>
																	</li>
																	<?php

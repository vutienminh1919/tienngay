		...
		<div class="col-xs-12">
			...
			<div class="page-title">
				...
				<div class="title_right text-right">
					<a class="btn btn-info" href="<?php echo base_url() ?>mic_tnds/index?tab=transaction">
						...
						<div class="table-responsive">
							<table class="table table-bordered m-table table-hover table-calendar table-report ">
								...
								<?php foreach ($mics as $mic) { ?>
									<tr>
										<th><?php echo $mic->customer_info->customer_name ?></th>
										<th><?php echo $mic->customer_info->customer_phone ?></th>
										<th><?php echo number_format($mic->mic_fee) . " VND" ?></th>
										<th><?php echo date('d/m/Y H:i:s', $mic->created_at) ?></th>
									</tr>
								<?php } ?>
								</tbody>
							</table>

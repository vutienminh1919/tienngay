		...
		<div class="col-xs-12">
			...
			<div class="page-title">
				...
				<div class="title_right text-right">
					<a href="<?php echo base_url() ?>mic_tnds/index?tab=transaction" class="btn btn-info">
					...
					<div class="" role="tabpanel" data-example-id="togglable-tabs">
						...
						<div class="table-responsive" style="overflow-y: auto">
							<table class="table table-bordered m-table table-hover table-calendar table-report ">
								...
								<tr>
									<th style="width:32px"><input type="checkbox" name="all_mic_tnds" value=""
																  id="selectAll"></th>
								...
								<tbody>
								<?php foreach ($mic_tnds as $key => $value) { ?>
									<tr style="text-align: center">
										<th style="width:32px"><input type="checkbox" name="mic_tnds[]"
																	  value="<?php echo $value->mic_code ?>"
																	  class="micCheckBox"></th>
										<td><?php echo $value->mic_code ?></td>
										...
										<td><?php echo number_format($value->mic_fee) . " VND" ?></td>
...
<!-- /page content -->
<script src="<?php echo base_url() ?>assets/js/mic_tnds/sendKT.js"></script>

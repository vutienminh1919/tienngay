    ...
    <div class="col-xs-12">
        <div class="page-title">
            <div class="title_left">
                ...
                <br>
                <small>
                    <a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="#">Lịch sử hợp đồng</a>
                </small>
                </h3>
            </div>
        </div>
                    ...
                    <div class="x_title">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <?php } ?>
                                <div class="row">
                                    <form action="<?php echo base_url('ksnb_report/doLich_su_hop_dong')?>" method="get" style="width: 100%;">
                                        <div class="col-lg-3">

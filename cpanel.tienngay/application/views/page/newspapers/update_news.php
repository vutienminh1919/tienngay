  ...
  <div class="row">
    ...
    <div class="col-xs-12">
        <div class="page-title">
            <div class="title_left">
                <h3><?php print $this->lang->line('update_news_papers')?>
                  <br/><br/>
                  <small><a href="<?php print base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="<?php print base_url('newspapers/listNews')?>"><?php print $this->lang->line('news_list')?></a> / <a href="#"><?php print $this->lang->line('update_news_papers')?></a></small>
                </h3>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <span class='div_error'></span>
                ...
                <form class="form-horizontal form-label-left" id="form_news" enctype="multipart/form-data" action="<?php print base_url("newspapers/doUpdateNews")?>" method="post">
        ...
        <br/>
             <div class="form-group row">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    <?php print $this->lang->line('link')?> <span class="text-danger">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="link" class="form-control " value="<?php !empty($news->link) ? print $news->link : print "" ?>" placeholder="<?php print $this->lang->line('link_pla')?>" select>
                  </div>
            </div>
              <div class="form-group row">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    <?php print $this->lang->line('source')?> <span class="text-danger">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="source" class="form-control " value="<?php !empty($news->source) ? print $news->source : print "" ?>" placeholder="<?php print $this->lang->line('source_pla')?>" select>
                  </div>
            </div>
          ...
          <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    <a href="<?php print base_url('newspapers/listNews')?>" class="btn btn-info ">
    ...
    <!-- /page content -->
    <script src="<?php print base_url();?>assets/js/newspapers/index.js"></script>

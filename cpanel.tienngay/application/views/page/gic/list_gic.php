  ...
  <div class="row top_tiles">
      ...
      <div class="page-title">
        <div class="title_left">
          <h3><?php echo $this->lang->line('gic_list')?> 
            <br>
            <small>
                <a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="#"><?php echo $this->lang->line('gic_list')?></a>
            </small>
          </h3>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
		  <div class="x_title">
			  ...
			  <div class="row">
				  <div class="col-xs-12 col-lg-12">
					  <div class="row">
						  <form action="<?php echo base_url('gic/listGic')?>" method="get" style="width: 100%;">
							  <div class="col-lg-3">
								  <label></label>
							  ...
							  <div class="col-lg-2 text-right">
								  <label></label>
								  <a style="background-color: #18d102;" href="<?=base_url()?>excel/exportListGic?fdate=<?=$fdate.'&tdate='.$tdate.'&isEasy=0'?>" class="btn btn-primary w-100" target="_blank"><i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp; Xuất excel</a>
							  </div>
						  </form>
					  </div>
        ...
        <?= !empty($gic_info->noiDungBaoHiem_GiaTriKhoanVay) ?  number_format($gic_info->noiDungBaoHiem_GiaTriKhoanVay) : ""?>
        ...
        <?php }else{ if((empty($contract_info->chan_bao_hiem) || $contract_info->chan_bao_hiem==2)  && $userSession['is_superadmin'] == 1){
        echo "Đã hủy" ; ?>
          <a href="javascript:void(0)" onclick="restore_gic_kv('<?=$gic->contract_id?>')" class="btn btn-info btn-sm">
              Tạo lại
            </a>
    ...
    function set_switchery() {
        $(".aiz_switchery").each(function () {
            ...
            changeCheckbox.onchange = function () {
                $.ajax({url: _url.base_url +'gic/doUpdateStatusWarehouse?id='+id+'&status='+ changeCheckbox.checked,

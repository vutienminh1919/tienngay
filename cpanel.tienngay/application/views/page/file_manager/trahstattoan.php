					...
					<div class="row">
						...
						<div class="col-xs-12 col-md-6 text-right dropdown-filter">
							...
							if ($userSession['is_superadmin'] == 1 || in_array("quan-ly-ho-so", $groupRoles) || in_array("van-hanh", $groupRoles)) : ?>
								<a target="_blank" href="<?php echo base_url("File_manager/ExportRecordsReturn?") ?>
									<?=
								'fdate=' . $fdate
								. '&tdate=' . $tdate
								. '&store=' . $store
							...
							<?php endif; ?>
							<form action="<?php echo base_url('file_manager/search_tattoan') ?>" method="get">
								<ul id="lockdulieu" class="dropdown-menu dropdown-menu-right"
									...
									<li class="form-group">
										...
										<select class="form-control" name="status">
											<option value="">-- Tất cả --</option>
											<?php
											foreach (file_manager_status_tattoan() as $key => $value) {
												?>
												<option
					...
					<div class="table-responsive">
						<table id="summary-total"
							...
							<tr>
								...
								<th width="400" style="text-align: center">Hồ sơ gửi lên</th>
								<th width="300" style="text-align: center">Quản lý hồ sơ thực nhận</th>
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<div id="SomeThing" class="simpleUploader">
							...
							<input id="uploadinput_2" type="file" name="file"
								   ...
								   data-type="fileReturn_3" class="focus">
						</div>
					</div>
				</div>
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<div id="SomeThing" class="simpleUploader">
							...
							<input id="uploadinput_3" type="file" name="file"
								   ...
								   data-type="fileReturn_4" class="focus">
						</div>
					</div>
				</div>
			...
			<div class="modal-body ">
				<div class="row">
					<div class="col-xs-12">
						...
						<div style="text-align: right">
							<button type="button" id="fileReturn_save_file" class="btn btn-info">Xác
								nhận
							</button>
							<button type="button" class="btn btn-primary close-hs" data-dismiss="modal"
									aria-label="Close">

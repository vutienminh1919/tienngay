...
<div class="right_col" role="main">
    <div class="container container-xt">
        <div class="wrapper-top">
            ...
            <button type="button" class="btn btn-success btn-top">Gọi nhà cung cấp <img class="theavatar" src="<?php echo base_url("assets/imgs/ql_xnt/phone.svg") ?>" alt=""></button>
        </div>
            ...
            <div class="form-content">
                ...
                <div class="form-button">
                    ...
                    <button type="button" class="btn btn-outline-success">
                        Xuất excel <img class="theavatar" src="<?php echo base_url("assets/imgs/ql_xnt/excel.svg") ?>" alt="">
                    </button>
                    <button type="button" class="btn btn-outline-success">
                        Import file <img class="theavatar" src="<?php echo base_url("assets/imgs/ql_xnt/push.svg") ?>" alt="">
                    </button>
                    <!-- Modal -->
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="modal-item">
                                        ...
                                        <select required>
                                            <option value="" disabled selected hidden>Chọn chuyên viên kinh doanh</option>
                ...
                <table class="table">
                    ...
                    <tbody class="tbody-line">
                        <tr>
                            ...
                            <td><a href="cvkd">linhltt@tienngay.vn</a></td>
                            <td>Đang hoạt động</td>
                            <td><a data-fancybox="gallery" href="https://lipsum.app/id/60/1600x1200" data-caption="First image">
                                    Xem ảnh <img class="theavatar" src="<?php echo base_url("assets/imgs/ql_xnt/eys.svg") ?>" alt="">
                                </a></td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>

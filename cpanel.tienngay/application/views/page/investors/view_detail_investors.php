...
<div class="right_col" role="main">
  ...
  <div class="col-xs-12">
    ...
    echo $this->lang->line('investors_view_detail')?>: <?=$investors->name?> 
          <br>
          <small>
            <a href="#"><i class="fa fa-home" ></i> Home</a> / <a href="<?php echo base_url('investors/listInvestors')?>"><?php echo $this->lang->line('investors_list')?></a> / <a href="#"><?php echo $this->lang->line('investors_view_detail')?></a>
          </small>
        </h3>
      </div>
               ...
               <?php 
                  ...
                  <tr>
                   <td><?php echo $stt ?></td>
                    ...
                    <td>
                      <a href="#" class="toggleTheDetail" data-code_contract="<?= !empty($contract->code_contract) ?  $contract->code_contract : ""?>" data-hinhthuctralai=" <?= !empty($contract->loan_infor->type_interest) ?  $contract->loan_infor->type_interest : ""?>" data-sotienvay=" <?= !empty($contract->loan_infor->amount_money) ?  $contract->loan_infor->amount_money : ""?>" data-laivay="<?=$investors->percent_interest_investor?> " data-stt="<?=$stt?>" data-target="thedetail-<?php echo $stt?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Chi tiết</a>
                    </td>
                  </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
       ...
       <input type="hidden" name="laivay" class="form-control " value="">
       <input type="hidden" name="hinhthuctralai" class="form-control " value="">
      <input type="hidden" name="sotienvay" class="form-control " value="">

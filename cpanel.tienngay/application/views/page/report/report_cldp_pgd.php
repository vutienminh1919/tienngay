...
<div class="right_col" role="main">
	...
	<div class="row top_tiles">
					...
					<h3> Báo cáo
						...
						<small>
							<a href="<?php echo base_url() ?>"><i class="fa fa-home"></i> Home</a> / <a href="#">
								Báo cáo trích lập dự phòng các khoản vay khó đòi cho phòng giao dịch</a>
						</small>
					</h3>
		...
		<div class="col-xs-12">
			<div class="row">
				<form action="<?php echo base_url('report_kt/report_tldp_pgd') ?>" method="get" style="width: 100%;">
					<div class="col-md-2">
						<label></label>

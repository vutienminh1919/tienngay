...
<div class="right_col" role="main">
	...
	<div class="container container-xt">
		...
		<div class="container-cart">
			...
			<div class="content">
				<a href="<?php echo base_url('assetLocation/business') . '?alarm=1&email=' . $_GET['email'] ?>">
				...
				<a href="<?php echo base_url('assetLocation/business') . '?alarm=5&email=' . $_GET['email'] ?>">
					<div class="content-cart-notify">
				...
				<a href="<?php echo base_url('assetLocation/business') . '?alarm=21&email=' . $_GET['email'] ?>">
					<div class="content-cart-notify">
				...
				<a href="<?php echo base_url('assetLocation/business') . '?alarm=2&email=' . $_GET['email'] ?>">
					<div class="content-cart-notify">
				...
				<a href="<?php echo base_url('assetLocation/business') . '?alarm=17&email=' . $_GET['email'] ?>">
					<div class="content-cart-notify">
					...
					<?php foreach ($contracts as $key => $contract) : ?>
						<tr style="text-align: center">
							...
							<td>
								...
								<?php if (in_array('van-hanh', $group_role)) : ?>
									<br>

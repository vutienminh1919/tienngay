		...
		<div class="wrapper-top">
			<div class="container-top">
				<nav aria-label="breadcrumb">
					<a href="<?php echo base_url() ?>assetLocation/business"><h3 class="d-inline-block">Quản lý hợp đồng
										...
										<div class="modal-item">
											...
											<select name="store">
												...
												<?php foreach ($stores as $s): ?>
													<?php if (empty($s->name)) continue; ?>
													<option value="<?php echo $s->id ?>" <?php echo $s->id == $_GET['store'] ? "selected" : "" ?>><?php echo $s->name ?></option>
												<?php endforeach; ?>
											</select>
										</div>
										<div class="modal-item">
				...
				<table class="table">
					...
					<?php foreach ($contracts as $key => $contract) : ?>
						<tr style="text-align: center">
							...
							<td>
								<a href="<?php echo base_url('assetLocation/business?email=' . $contract->created_by) ?>"
								   target="_blank">

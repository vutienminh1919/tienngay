...
<div class="right_col" role="main">
	<div class="container container-xt">
		<div class="wrapper-top">
			...
			<!--				<a href="xnt_khotax"><button type="button" class="btn btn-success btn-top btn-item">Xuất nhập tồn <img class="theavatar" src="-->
			<?php //echo base_url("assets/imgs/ql_xnt/xnt.svg") ?><!--" alt=""></button></a>-->
			<!--				<a href="cptb"><button type="button" class="btn btn-success btn-top">Lịch sử thiết bị <img class="theavatar" src="-->
			<?php //echo base_url("assets/imgs/ql_xnt/time.svg") ?><!--" alt=""></button></a>-->
			<!--			</div>-->
		</div>
		...
		<div class="panel">
			<div class="form-content">
				...
				<div class="form-button">
					...
					<!--						Tìm kiếm <img class="theavatar" src="-->
					<?php //echo base_url("assets/imgs/ql_xnt/search.svg") ?><!--" alt="">-->
					<!--					</button>-->
					<a type="button" class="btn btn-outline-success"
					   href="<?php echo base_url("assetLocation/all_device") ?>" target="_blank">Xuất excel <img
								class="theavatar"
								src="
			...
			<div class="form-table table-responsive">
				<table class="table">
					...
					<tr>
						...
						<th scope="col" rowspan="2">Tên Kho</th>
					...
					<?php foreach ($warehouses as $key => $warehouse): ?>
						<tr>
							...
							<td><?php echo $warehouse->total ?></td>
							<td><?php echo $warehouse->total_active ?></td>
							<td><?php echo $warehouse->total_new ?></td>
							<td><?php echo $warehouse->total_old ?></td>
							<td><?php echo $warehouse->total_broken ?></td>

							<td>
								<a href="<?php echo base_url('assetLocation/warehouse_detail/') . $warehouse->_id ?>">Xem
		...
		<!--				<div class="btn-group">-->
		<!--					<div class="btn btn-secondary btn-lg dropdown-toggle btn-select" type="button"-->
		<!--						 data-toggle="dropdown" aria-expanded="false">-->
		<!--						<img class="theavatar" src="-->
		<?php //echo base_url("assets/imgs/ql_xnt/dropdow.svg") ?><!--" alt="">-->
		<!--					</div>-->

				...
				<div class="title_left">
					<h3><?php echo $this->lang->line('create_news') ?>
						...
						<small><a href="<?php echo base_url() ?>"><i class="fa fa-home"></i> Home</a> / <a
									href="<?php echo base_url('FinancialHandbook/listHandbook') ?>">Danh sách cẩm
								nang</a> / <a href="#"><?php echo $this->lang->line('create_news') ?></a></small>
					</h3>
				</div>
			</div>
		</div>
			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<form class="form-horizontal form-label-left" id="form_news" enctype="multipart/form-data"
						  action="<?php echo base_url("FinancialHandbook/doAddHandbook") ?>" method="post">
							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="vi">
									...
									<div class="form-group row">
										...
										<div class="col-lg-6 col-sm-12 col-xs-12 ">
											<div class="radio-inline text-primary">
												<label>
													<input type="radio" name="type_new" value="3" checked="checked">
													Cảm nang tài chính
												</label>
											</div>
											<div class="radio-inline text-primary">
												<label>
													<input type="radio" name="type_new" value="4"> Bảo hiểm
												</label>
											</div>
											<div class="radio-inline text-primary">
												<label>
													<input type="radio" name="type_new" value="10"> Cẩm nang CTV
												</label>
											</div>
									...
									<div class="form-group row insurance-div">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<textarea cols="100" rows="2" wrap="soft" class="form-control"
													  id="benefit_vi" name="benefit_vi"
													  placeholder="Nhập nội dung quyền lợi Bảo hiểm"></textarea>
									...
									<div class="form-group row insurance-div">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<textarea cols="100" rows="2" wrap="soft" class="form-control"
													  id="fee_insurance_vi" name="fee_insurance_vi"
													  placeholder="Nhập nội dung phí bảo hiểm"></textarea>
										</div>
									</div>
									<div class="form-group row insurance-div">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<select class="form-control" id="type_finance_vi" name="type_finance_vi">
												...
												<?php foreach (lead_type_finance() as $key => $type_finance) {
													...
													<option value="<?= $key ?>"><?php echo $type_finance;?></option>
												<?php } ?>
											</select>
										</div>
									</div>
									<div class="form-group row">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">
											<?php echo $this->lang->line('summary') ?> <span
									...
									<div class="form-group row">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">
											<?php echo $this->lang->line('content') ?> <span
													class="text-danger">*</span>
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<textarea rows="5" cols="100" class="form-control" id="content_vi"
													  name="content_vi"
													  placeholder="<?php echo $this->lang->line('content_pla') ?>"></textarea>
										</div>
									</div>
								...
								<div role="tabpanel" class="tab-pane" id="en">
									...
									<div class="form-group row insurance-div_en">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">
											Quyền lợi bảo hiểm
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<textarea cols="100" rows="2" wrap="soft" class="form-control" id="benefit_en"  name="benefit_en" placeholder="Nhập nội dung quyền lợi Bảo hiểm"></textarea>
										</div>
									</div>
									<div class="form-group row insurance-div_en">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<textarea cols="100" rows="2" wrap="soft" class="form-control" id="fee_insurance_en"  name="fee_insurance_en" placeholder="Nhập nội dung phí bảo hiểm"></textarea>
										</div>
									</div>
									<div class="form-group row insurance-div_en">
										<label class="control-label col-md-3 col-sm-3 col-xs-12">
						...
						<div class="form-group row">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="page_title_seo" class="form-control"
									   placeholder="Nhập tiêu đề SEO" select>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<textarea cols="100" rows="3" wrap="soft" class="form-control" id="description_tag_seo"
										  name="description_tag_seo" placeholder="Nhập nội dung mô tả SEO"></textarea>
						...
						<div class="form-group row">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="keyword_tag_seo" class="form-control "
									   placeholder="Nhập từ khóa SEO" select>
							</div>
						</div>
						<div class="form-group row">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="url_seo" class="form-control "
									   placeholder="Nhập url SEO, Ví dụ: Vay theo cà vẹt xe" select>
							</div>
						</div>
						<!--						END SEO-->
						<br/>
						...
						<div class="form-group row">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select class="form-control" id="selectize_province" name="province">
						...
						<div class="form-group">
							<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
								<button class="btn btn-success  create_handbook">
									<i class="fa fa-save"></i>
									<?php echo $this->lang->line('save') ?>
								</button>
								<a href="<?php echo base_url('FinancialHandbook/listHandbook') ?>"
								   class="btn btn-info ">
...
<script>
	$(document).ready(function () {
		...
		var type_hanbook = $("input[name='type_new'][value='3']");
		var type_insurance = $("input[name='type_new'][value='4']");
		$('.insurance-div').hide();
		type_hanbook.on('click change', function (e) {
			$('.insurance-div').hide();
		});
		type_insurance.on('click change', function (e) {
			$('.insurance-div').show();
		});

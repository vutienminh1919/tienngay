...
<div class="table-responsive">
	...
	<table class="table table-bordered m-table table-hover table-calendar table-report datatablebutton list_field_qlkv">
		...
		if (!empty($contractData)) {
			...
			foreach ($contractData as $key => $contract) {
				...
				?>
				<?php if ($debt_field_email == $userInfo['email'] || in_array('supper-admin', $groupRoles) || in_array("tbp-thu-hoi-no", $groupRoles) || in_array("van-hanh", $groupRoles) || in_array("lead-thn", $groupRoles)) { ?>

		...
		<div class="table_app_all">
				...
				<div class="row">
					<div class="col-xs-12 col-lg-8">
						<div class="title">
							...
							<span>Trưởng phòng giao dịch - <?= $data->store_name ?> </span>
						</div>
					</div>
					<div class="col-xs-12 col-lg-4 mb-3 text-right">
						...
						<form action="<?php echo base_url('kpi/detail_asm_dashboard') ?>" method="get">
								...
								<li class="form-group">
									<div class="row">
										...
										<div class="col-xs-12 col-md-6">
											...
											<input type="hidden" class="form-control" name="store_id" value="<?= !empty($store_id) ?  $store_id : '' ?>" >
										</div>
									</div>
								</li>
			...
			<div class="dashboard-right-sys">
				...
				foreach ($data_kpi as $key => $value) {
					...
					$total_giai_ngan_chi_tieu_ti_trong += $value->total_giai_ngan_chi_tieu_ti_trong;
				}
				...
				if ($tong_chi_tieu_bao_hiem != 0) {
					$bao_hiem = round(($data->total_doanh_so_bao_hiem / $tong_chi_tieu_bao_hiem) * $tong_TT_bao_hiem);
				}
				if ($tong_chi_tieu_giai_ngan != 0) {
					$giai_ngan = round(($total_giai_ngan_chi_tieu_ti_trong / $tong_chi_tieu_giai_ngan) * $tong_TT_giai_ngan);
				}

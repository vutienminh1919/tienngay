                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
								...
								<div class="form-group">
									...
									<div class="col-lg-9 col-md-6 col-sm-6 col-xs-12">
										<input disabled type="text" required id="customer_identify_new" value="<?= $contractInfor->customer_infor->customer_identify_new ? $contractInfor->customer_infor->customer_identify_new : "" ?>" class="form-control identify-new-autocomplete">
										<div id="resultsIdentifyNew" class="smartsearchresult "></div>
									</div>
								</div>
                                <div class="form-group">

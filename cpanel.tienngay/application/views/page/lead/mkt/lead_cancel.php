		...
		<div class="col-xs-9">
			<div class="page-title">
				<div class="title_left" style="width: 100%">
                    ...
                    <br>
                    <small>
                        <a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a>/ <a href="#">MKT</a> / <a href="#">Lead hủy</a>
                    </small>
                    </h3>
...
<div class="col-xs-12">
        <div class="row">
                   ...
                   <form action="<?php echo base_url('lead_custom/mkt_lead_cancel')?>" method="get" style="width: 100%;">
                  <div class="row">
                  <div class="col-lg-3">
...
<div role="tabpanel" class="tab-pane" id="en">
              <br/>
                 <div class="table-responsive" >
     <table id="datatable-button" class="table table-striped datatable-buttons thedatatable"  style="width: 100%;">
            <thead>
            <tr>
                <th>#</th>
                <th>UTM Source</th>

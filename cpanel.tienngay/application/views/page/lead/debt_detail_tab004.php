...
<div class="row">
	<div class="col-lg-2">
		<select class="form-control" id="cskh_tab4">
	...
	<div class="col-lg-1">
		<a class="btn btn-info "
		   onclick="check_all_cskh_tab4(this)" data-tab="4">
			Chọn
		</a>
	</div>
	<div class="col-lg-2">
		...
		<div class="dropdown-menu">
			...
			<a class="dropdown-item">
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="show-hide-date-lead" data-control-column="3" checked="checked">
					<label class="custom-control-label" >NGÀY THÁNG</label>
				</div>
			</a>
			<a class="dropdown-item">
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="show-hide-source" data-control-column="4" checked="checked">
					<label class="custom-control-label" >NGUỒN</label>
				</div>
			</a>
			<a class="dropdown-item">
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="show-hide-utm-source" data-control-column="5" checked="checked">
					<label class="custom-control-label" >UTM_Source</label>
				</div>
			</a>
			<a class="dropdown-item" href="#">
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="show-hide-utm-campaign" data-control-column="6" checked="checked">
			...
			<a class="dropdown-item">
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="show-hide-lead-status" data-control-column="9" checked="checked">
			...
			<a class="dropdown-item">
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="show-hide-reason-cancel" data-control-column="10" checked="checked">
					<label class="custom-control-label" >LÝ DO HỦY</label>
				</div>
			</a>
			<a class="dropdown-item">
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="show-hide-store" data-control-column="11" checked="checked">
			...
			<a class="dropdown-item" href="#">
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="show-hide-confirm" data-control-column="12" checked="checked">
					<label class="custom-control-label">XÁC NHẬN</label>
				</div>
			</a>
			<a class="dropdown-item" href="#">
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" id="show-hide-loan-products" data-control-column="13" checked="checked">
...
<div class="table-responsive">
	<div><?php echo $result_count4; ?></div>
	<table id="datatablebutton_tab4" class="table table-striped thedatatabl hide-show-column">
		<thead>
		<tr>
			<th>#</th>
			<th>CHỌN</th>
		...
		if (!empty($leadsData4)) {
			...
			foreach ($leadsData4 as $key => $lead) {
             ...
             <a class="btn btn-info "
               ...
               Nhận
					...
					<td>
						<?= !empty($lead->fullname) ? wordwrap($lead->fullname, 27, "<br>\n") : '' ?>
						<br>

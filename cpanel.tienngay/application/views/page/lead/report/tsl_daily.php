    ...
    <div class="col-xs-9">
      <div class="page-title">
        <div class="title_left" style="width: 100%">
          <h3>Báo cáo TLS - Hàng ngày
                    <br>
                    <small>
                        <a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a>/ <a href="#">Lead</a> / <a href="#">Báo cáo TLS - Hàng ngày</a>
                    </small>
                    </h3>
...
<div class="col-xs-12">
        <div class="row">
                ...
                <form action="<?php echo base_url('lead_custom/lead_tsl_daily')?>" method="get" style="width: 100%;">
                  <div class="row">
                  <div class="col-lg-3">

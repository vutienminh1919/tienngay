...
<div class="right_col" role="main">
	...
	<div class="row top_tiles">
		...
		<div class="col-xs-12">
          <div class="row">
				  <form action="<?php echo base_url('lead_custom/historyCall_Missed')?>" method="get" style="width: 100%;">
					  <div class="col-lg-3">
						  <label></label>
							...
							<!-- 	<td><?= !empty($history->hangupCause) ? recoding_status($history->hangupCause) : "" ?></td> -->
								...
								<td class="text-right">
										...
										<a href="javascript:void(0)"
										   onclick="call_for_customer('<?=encrypt($history->fromNumber)?>','','')"
										   class="btn btn-info callmodal"> <i class="fa fa-phone" id="icon_call"></i>
											GỌI
...
<div class="modal fade" id="approve_call" tabindex="-1" role="dialog" aria-labelledby="ContractRejectModal" aria-hidden="true">

...
<body class="c33">
  <div>
    <p class="c5"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 184.28px; height: 44.45px;"><img alt="" src="https://tienngay.vn/assets/home/images/logo.png" style="width: 184.28px; height: 44.45px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p>
  </div>
  <p class="c20"><span class="c17 c43">PHIẾU NHẬP KHO</span></p>
  <p class="c20"><span class="c22">&nbsp;</span></p>
  <!-- <p class="c46"><span class="c24 c26">Số: </span><span class="c24 c44">................................................</span></p> -->
  <p class="c6"><span class="c0">Ngày <?= date('d') ?> tháng <?= date('m') ?> năm <?= date('Y') ?></span></p>
    ...
    <tbody>
      <tr class="c8">
        <td class="c7" colspan="1" rowspan="1">
          <p class="c5"><span class="c0">Hợp đồng số:</span></p>
        </td>
        <td class="c30" colspan="1" rowspan="1">
          <p class="c5"><span class="c0">: <?= $asset->code_contract ?></span></p>
        </td>
      ...
      <tr class="c8">
        <td class="c7" colspan="1" rowspan="1">
          <p class="c5"><span class="c0">Người vận chuyển:</span></p>
        </td>
        <td class="c30" colspan="1" rowspan="1">
          <p class="c5"><span class="c0">:..........................................</span></p>
        </td>
        <td class="c3" colspan="1" rowspan="1">
          <p class="c5"><span class="c0">Số điện thoại:</span></p>
        </td>
        <td class="c15" colspan="1" rowspan="1">
          <p class="c5"><span class="c0">:..........................................</span></p>
        </td>
      ...
      <tr class="c8">
        <td class="c7" colspan="1" rowspan="1">
          <p class="c5"><span class="c0">Phương tiện vận chuyển:</span></p>
        </td>
        <td class="c30" colspan="1" rowspan="1">
          <p class="c5"><span class="c0">:..........................................</span></p>
        </td>
      ...
      <tr class="c8">
        <td class="c7" colspan="1" rowspan="1">
          <p class="c5"><span class="c0">Xuất tại PGD</span></p>
        </td>
        <td class="c30" colspan="1" rowspan="1">
          <p class="c5"><span class="c0">: <?= $asset->store->name ?></span></p>
        </td>
        <td class="c3" colspan="1" rowspan="1">
          <p class="c5"><span class="c0">Nhập tại kho</span></p>
        </td>
        <td class="c15" colspan="1" rowspan="1">
          <p class="c5"><span class="c0">: <?= $warehouse->name ?></span></p>
        </td>
      </tr>
      <tr class="c8">
        <td class="c7" colspan="2" rowspan="1">
          <p class="c5"><span class="c0">Xác nhận bàn giao tài sản chi tiết như sau</span></p>
        </td>
      </tr>
  ...
  <div style="padding: 0 7px">
    <table class="c4 tablebordered">
      <thead>
        <tr class="c8">
          <th class="c7" colspan="1" style="width:10%;text-align:center"><strong class="c0">STT</strong></th>
          <th class="c7" colspan="2"><span class="c0">Mã tài sản</span></th>
          <th class="c7" colspan="2"><span class="c0">Tên tài sản</span></th>
          <th class="c7" colspan="2"><span class="c0">Biển kiểm soát</span></th>
          <th class="c7" colspan="2"><span class="c0">Giá trị xe hiện tại</span></th>
        </tr>
      </thead>
      <tbody>
        <tr class="c8">
          <td class="c7" colspan="1" style="width:10%;text-align:center"><strong class="c0">1</strong></td>
          <td class="c7" colspan="2"><span class="c0"><?= $status_asset->_id->{'$oid'} ?></span></td>
          <td class="c7" colspan="2"><span class="c0"><?= $asset->loan_infor->name_property->text ? $asset->loan_infor->name_property->text : "" ?></span></td>
          <td class="c7" colspan="2"><span class="c0"><?= $asset->property_infor[2]->value ? $asset->property_infor[2]->value : "" ?></span></td>
          <td class="c7" colspan="2"><span class="c0"><?= $asset->loan_infor->price_property ? number_format($asset->loan_infor->price_property) : "" ?>đ</span></td>
        </tr>

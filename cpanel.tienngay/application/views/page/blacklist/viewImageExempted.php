		...
		<div class="page-title">
			<div class="title_left">
				<h3>Chứng từ
					<br>
					<small>
						<a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a>/ <a href="<?php echo base_url('exemptions/getContractExempted')?>">Danh sách hợp đồng đã được duyệt miễn giảm</a> / <a href="#">Chứng từ</a>
					</small>
				</h3>
			</div>
			<div class="title_right text-right">
				<a href="<?php echo base_url('exemptions/getContractExempted')?>" class="btn btn-info ">

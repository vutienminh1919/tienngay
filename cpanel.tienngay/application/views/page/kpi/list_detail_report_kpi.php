    ...
    <div class="col-xs-12">
      <div class="page-title">
        <div class="title_left">
          <h3>Chi tiết số liệu KPI phòng giao dịch
          <br>
			<small>
			<a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="#>">Chi tiết số liệu KPI phòng giao dịch</a>
			</small>
          </h3>
        </div>
      </div>
        ...
        <div class="x_title">
          ...
          <div class="row">
            <div class="col-xs-12 col-lg-12">
				  ...
				  <form action="<?php echo base_url('kpi/listDetailKPI_pgd')?>" method="get" style="width: 100%;">
				  	      <div class="row">
				  	      	<div class="col-lg-3">
						...
						<td><?= !empty($kpi->store->name) ? $kpi->store->name : '' ?></td>
						  ...
						  <?php
						  	...
						  	foreach ($storeData as $value){
						  		if ((trim($kpi->store->name) == trim($value->name)) && $value->type_pgd == 1){
									$status_pgd = "Đang hoạt động";
								} elseif ((trim($kpi->store->name) == trim($value->name)) && $value->type_pgd == 2){
									$status_pgd = "Tạm dừng";
								}
							}

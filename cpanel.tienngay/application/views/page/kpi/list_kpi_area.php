		...
		<div class="x_panel">
			...
			<div class="x_content">
				<div class="row">
					<div class="col-xs-12">
						<div class="row">
							<form class="form-inline" action="<?php echo base_url('kpi/listKPI_area') ?>"
					...
					<div class="col-xs-12">
						<div class="title_right text-right row">
							...
							<div class="col-lg-2">
								<a href="#" class="btn btn-info " id="add_one_month_area"><i class="fa fa-plus"
						...
						<div class="table-responsive">
							...
							<table id="datatable-button" class="table table-striped datatablebutton">
								...
								<tr>
									...
									<th rowspan="3" class="center">Vùng</th>
								...
								if (!empty($kpiData)) {
									...
									foreach ($kpiData as $key => $tran) {
										...
										<tr class="center">
											...
											<td><?= !empty($tran->area->name) ? $tran->area->name : '' ?></td>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$(".txtedit").on('focusout', function () {
			...
			$.ajax({
				url: _url.base_url + 'kpi/update_area',
				type: 'post',

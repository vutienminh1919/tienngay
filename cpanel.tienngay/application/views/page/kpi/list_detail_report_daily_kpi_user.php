    ...
    <div class="col-xs-12">
      <div class="page-title">
        <div class="title_left">
          <h3>Chi tiết số liệu Dashboard giao dịch viên
          <br>
			<small>
			<a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="#>">Chi tiết số liệu Dashboard giao dịch viên</a>
			</small>
          </h3>
        </div>
      </div>
        ...
        <div class="x_title">
          ...
          <div class="row">
            <div class="col-xs-12 col-lg-12">
				  ...
				  <form action="<?php echo base_url('kpi/listDetail_daily_user')?>" method="get" style="width: 100%;">
				  	      <div class="row">
					  <div class="col-lg-3">
						  <label></label>
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
						...
						<td class="center"><?= !empty($kpi->total_so_tien_vay) ? number_format($kpi->total_so_tien_vay) : '0' ?></td>
						<td class="center"><?= !empty($kpi->total_du_no_dang_cho_vay) ? number_format($kpi->total_du_no_dang_cho_vay) : '0' ?></td>

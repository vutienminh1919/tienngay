		...
		<div class="x_panel">
			...
			<div class="x_content">
				<div class="row">
					<div class="col-xs-12">
						<div class="row">
							<form class="form-inline" action="<?php echo base_url('kpi/listKPI_gdv') ?>"
					...
					<div class="col-xs-12">
						<div class="title_right text-right row">
							...
							<div class="col-lg-2">
								<a href="#" class="btn btn-info " id="add_one_month_gdv"><i class="fa fa-plus"
						...
						<div class="table-responsive">
							...
							<table id="datatable-button" class="table table-striped datatablebutton">
								...
								<tr>
									...
									<th rowspan="3" class="center">PGD</th>
									<th rowspan="3" class="center">Chuyên viên kinh doanh</th>
								...
								if (!empty($kpiData)) {
									...
									foreach ($kpiData as $key => $tran) {
										...
										<tr class="center">
											...
											<td><?= !empty($tran->email_gdv) ? $tran->email_gdv : '' ?></td>

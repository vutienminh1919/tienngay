...
<div class="row">
    <div class="col-xs-12">
      <div class="page-title">
        <h3>Thanh toán hóa đơn điện
        <br>
					<small>
					<a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="<?php echo base_url('VimoBilling')?>"><?= $this->lang->line('Pay_the_bill')?></a>/ <a href="#">Thanh toán hóa đơn điện</a>
					</small>
        </h3>
        ...
        <div class="x_content">
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab1" class="nav nav-tabs " role="tablist">
              <li role="presentation" class="active"><a href="<?php echo base_url("VimoBilling/billingElectric")?>" ><i class="fa fa-bolt" aria-hidden="true"></i> <?= $this->lang->line('EVN_electricity_bill')?></a>
              </li>
              <li role="presentation" class=""><a href="<?php echo base_url("VimoBilling/billingWater")?>" ><i class="fa fa-tint" aria-hidden="true"></i> <?= $this->lang->line('Water_bill')?></a>
              </li>
                ...
                <div class="card-body">
                  <div class="container">
                    ...
                    <div class="setup-content" id="step-1">
                      ...
                      <div class="form-group">
                        ...
                        ?>
                          <a class="btn dropdown-toggle btn btn-default w-100" data-toggle="dropdown" href="#" style="text-align:left !important">
                            <!-- <img src="<?php echo base_url();?>assets/imgs/logo/logo_evn.png" style="width:24px;margin-right: 5px"> -->
                      ...
                      <div class="form-group">
                        <label class="control-label"><?= $this->lang->line('Enter_customer_code')?></label>
                        <input  type="text" required="required" name="customer_code" class="form-control" placeholder="<?= $this->lang->line('Customer_code')?>..." />
                        <input  type="hidden" class="form-control " name="sevice_code_vimo" value="BILL_ELECTRIC"/>
                        <input  type="hidden" class="form-control " name="sevice_name_vimo" value="Thanh toán hóa đơn điện EVN"/>
                    ...
                    <div class="setup-content" id="step-2">
                      <div class="card card-billing-recipe-result">
                        <div class="card-header">
                          <!-- <div class="thelogo">
                            <img class="logo" src="<?php echo base_url();?>assets/imgs/logo/logo_evn.png" alt="">
                          </div> -->

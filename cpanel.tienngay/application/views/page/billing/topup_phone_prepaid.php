        ...
        <div class="x_content">
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab1" class="nav nav-tabs " role="tablist">
              <li role="presentation" class="active"><a href="#" > Nạp thuê bao trả trước</a>
              </li>
              <li role="presentation" class=""><a href="<?php echo base_url("VimoBilling/topupPhoneAfterpaid")?>" > Nạp thuê bao trả  sau</a>
              </li>
            ...
            <div id="myTabContent2" class="tab-content">
              <div role="tabpanel" class="tab-pane fade active in" id="tab_prepaid" aria-labelledby="tab_prepaid">
                ...
                <div class="card-body text-center">
                  <br>
                  <input  type="hidden" class="form-control " name="sevice_code_vimo" value="TOPUP_TELCO_PREPAID"/>
                  <input  type="hidden" class="form-control " name="sevice_name_vimo" value="Nạp tiền điện thoại trả trước"/>

  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="page-title">
        <h3>Mua thẻ / Nạp tiền thuê bao</h3>
        ...
        <div class="x_content">
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab1" class="nav nav-tabs " role="tablist">
              <li role="presentation" ><a href="<?php echo base_url("VimoBilling/topupPhonePrepaid")?>">Nạp thuê bao trả trước</a>
              </li>
              <li role="presentation" class="active"><a href="#">Nạp thuê bao trả  sau</a>
              </li>
              <li role="presentation" class=""><a href="<?php echo base_url("VimoBilling/pincodePhoneCardcode")?>">Mua mã thẻ điện thoại</a>
              </li>
            </ul>
            <div id="myTabContent2" class="tab-content">
              <div role="tabpanel" class="tab-pane in active" id="tab_afterpaid" aria-labelledby="tab_afterpaid">
                ...
                <div class="card-body text-center">
                  <br>
                  <input  type="hidden" class="form-control " name="sevice_code_vimo" value="TOPUP_TELCO_POSTPAID"/>
                  <input  type="hidden" class="form-control " name="sevice_name_vimo" value="Nạp tiền điện thoại trả sau"/>
                  ...
                  <input  type="hidden" class="form-control " name="number_card" value="1"/>

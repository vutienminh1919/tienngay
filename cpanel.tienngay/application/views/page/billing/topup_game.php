        ...
        <div class="x_content">
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab1" class="nav nav-tabs " role="tablist">
              <li role="presentation" class="active"><a href="#" >Nạp thẻ tài khoản game</a>
              </li>
              <li role="presentation" class=""><a href="<?php echo base_url("VimoBilling/pincodeGame")?>" role="tab" >Mua mã thẻ game</a>
              </li>
            </ul>
              ...
              <div role="tabpanel" class="tab-pane fade active in" id="tab_directly" aria-labelledby="tab_directly">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group m-0 step2">
                    <input type="text" class="form-control" name='customer_phone' placeholder="Tài khoản game">
                  </div>
                </div>
                <div class="card-body">
                ...
                <div class="card-body text-center">
                  <br>
                  <input  type="hidden" class="form-control " name="sevice_code_vimo" value="TOPUP_GAME"/>
                  <input  type="hidden" class="form-control " name="sevice_name_vimo" value="Nạp tiền tài khoản game"/>

...
<div class="row">
    <div class="col-xs-12">
      ...
      <h3>Thanh toán hóa đơn tài chính 
        <br>
					<small>
					<a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="<?php echo base_url('VimoBilling')?>"><?= $this->lang->line('Pay_the_bill')?></a>/ <a href="#">Thanh toán hóa đơn tài chính</a>
					</small>
        </h3>
          ...
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab1" class="nav nav-tabs" role="tablist">
              <li role="presentation" >
                <a href="<?php echo base_url("VimoBilling/billingElectric")?>" ><i class="fa fa-bolt" aria-hidden="true"></i> <?= $this->lang->line('EVN_electricity_bill')?></a>
              </li>
              <li role="presentation"  >
                <a href="<?php echo base_url("VimoBilling/billingWater")?>" ><i class="fa fa-tint" aria-hidden="true"></i> <?= $this->lang->line('Water_bill')?></a>
              </li>
              <li role="presentation" class="active">
                <a href="<?php echo base_url("VimoBilling/billingFinance")?>" ><i class="fa fa-money" aria-hidden="true"></i> <?= $this->lang->line('Finance_bill')?></a>
              </li>
            </ul>
                ...
                <div class="card-body">
                  <div class="container">
                    ...
                    <div class="setup-content" id="step-1">
                      ...
                      <div class="form-group">
                        ...
                        ?>
                          <a class="btn dropdown-toggle btn btn-default w-100" data-toggle="dropdown" href="#" style="text-align:left !important">
                            <!-- <img src="<?php echo base_url();?>assets/imgs/logo/logo_fecr.png" style="width:24px;margin-right: 5px"> -->
                          ...
                          ?>
                            ...
                            <!-- <img src="<?php echo base_url();?>assets/imgs/logo/logo_mrc.png" style="width:24px;margin-right: 5px"> -->
                            <?= !empty($value->name) ? $value->name : "" ?></a> </li>
                            <?php }}?>
                          </ul>
                        </div>
                        <script>
                      ...
                      <div class="form-group">
                        <label class="control-label"><?= $this->lang->line('CardID_Contract_number')?></label>
                        <input  type="text" required="required" name="customer_code" class="form-control" placeholder="<?= $this->lang->line('Customer_code')?>..." />
                        <input  type="hidden" class="form-control " name="sevice_code_vimo" value="BILL_FINANCE"/>
                        <input  type="hidden" class="form-control " name="sevice_name_vimo" value="Thanh toán tài chính"/>
                      ...
                      <button class="btn btn-primary nextBtn pull-right nextBtnBill" type="button"><?= $this->lang->line('next')?></button>
                    ...
                    <div class="setup-content" id="step-2">
                      <div class="card card-billing-recipe-result">
                        <div class="card-header">
                          ...
                          <!-- <p class="text-2" style="margin:0"> Số tền  đến hạn</p>
                      ...
                      <div class="text-center">
                        <button class="btn btn-danger backBtn" type="button"><?= $this->lang->line('Come_back')?></button>

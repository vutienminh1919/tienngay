        ...
        <div class="x_content">
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab1" class="nav nav-tabs " role="tablist">
              <li role="presentation" ><a href="<?php echo base_url("VimoBilling/topupPhonePrepaid")?>" id="prepaid-tabb" > Nạp thuê bao trả trước</a>
              </li>
              <li role="presentation" ><a href="<?php echo base_url("VimoBilling/topupPhoneAfterpaid")?>" >Nạp thuê bao trả  sau</a>
              </li>
              <li role="presentation" class="active"><a href="#">Mua mã thẻ điện thoại</a>
              </li>
            </ul>
            ...
            <div role="tabpanel" class="tab-pane active in" id="tab_cardcode" aria-labelledby="tab_cardcode">
              ...
              <div class="card-body text-center">
                <br>
                <input  type="hidden" class="form-control " name="sevice_code_vimo" value="PINCODE_TELCO"/>
                <input  type="hidden" class="form-control " name="sevice_name_vimo" value="Mua mã thẻ điện thoại"/>

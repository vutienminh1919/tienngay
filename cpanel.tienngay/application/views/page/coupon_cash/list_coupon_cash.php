    ...
    <div class="col-xs-12">
      <div class="page-title">
        <div class="title_left">
          <h3>Danh sách giảm trừ Phiếu thu Tiền mặt
            <br>
            <small>
                <a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="#">Danh sách giảm trừ Phiếu thu Tiền mặt</a>
            </small>
          </h3>
        </div>
        <div class="title_right text-right">
          <a href="<?php echo base_url("coupon_cash/createCoupon_cash")?>" class="btn btn-info " ><i class="fa fa-plus" aria-hidden="true"></i>Tạo giảm trừ BH KV</a>
        </div>
      </div>
    </div>
            ...
            <div class="col-xs-12">
              ...
              <div class="table-responsive">
                <table id="datatable-buttons" class="table table-striped">
                  ...
                  <tbody>
                  <?php 
                    if(!empty($coupon_cashData)) {
                        $stt = 0;
                        foreach($coupon_cashData as $key => $coupon){
                    ...
                    <tr class='coupon_<?= !empty($coupon->_id->{'$oid'}) ? $coupon->_id->{'$oid'} : "" ?>'>
                      ...
                      <td>
						  <a class="btn btn-primary"  href="<?php echo base_url("coupon_cash/update?id=").$coupon->_id->{'$oid'}?>">
    ...
    function set_switchery() {
        $(".aiz_switchery").each(function () {
            ...
            changeCheckbox.onchange = function () {
                $.ajax({url: _url.base_url +'coupon_cash/doUpdateStatusCoupon_cash?id='+id+'&status='+ changeCheckbox.checked,

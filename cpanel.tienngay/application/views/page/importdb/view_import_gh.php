		...
		<div class="col-xs-12">
			<div class="page-title">
				<div class="title_left">
					<h3>Danh sách hợp đồng gia hạn import 
						<br>
						<small>
							<a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="#>">Danh sách hợp đồng gia hạn </a>
						</small>
					</h3>
				</div>
			</div>
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="x_title">
					...
					<div class="row">
						<div class="col-xs-12 col-lg-12">
							<div class="row">
								<form action="<?php echo base_url('importDatabase/list_import_gh')?>" method="get" style="width: 100%;">
									<div class="col-lg-3">
										<label></label>
           ...
           <th>Chi tiết</th>
									...
									if(!empty($contractData)){
                                        ...
                                        $count_gh=count(json_decode(json_encode($contract->extend_all ,true),true));
                                        //var_dump($contract->code_contract_disbursement); die;
											?>

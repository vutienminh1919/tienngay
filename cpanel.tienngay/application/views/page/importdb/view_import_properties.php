				...
				<div class="row">
					<div class="col-xs-12 col-md-6">
						<div class="dashboarditem_line2 orange">
							<div class="thetitle">
								<i class="fa fa-upload"></i> Import Tài sản
							</div>
							<div class="panel panel-default">
								<form class="form-inline" id="form_import_properties" action="<?php echo base_url('ImportProperties/import_properties') ?>" enctype="multipart/form-data" method="post">
									...
									<button type="submit" class="btn btn-primary" id="import_properties" style="margin:0"><?= $this->lang->line('Upload') ?></button>
								</form>
							</div>
						</div>
					</div>

		...
		<div class="col-xs-12">
			...
			<div class="page-title">
				...
				<div class="title_right text-right">
					<a href="<?php echo base_url() ?>gic_easy/index?tab=transaction" class="btn btn-info">
					...
					<div class="" role="tabpanel" data-example-id="togglable-tabs">
						...
						<div class="table-responsive" style="overflow-y: auto">
							<table class="table table-bordered m-table table-hover table-calendar table-report ">
								...
								<tr>
									<th style="width:32px"><input type="checkbox" name="all_gic_easy" value=""
																  id="selectAll"></th>
								...
								<tbody>
								<?php foreach ($gic_easy as $key => $value) { ?>
									<tr style="text-align: center">
										<th style="width:32px"><input type="checkbox" name="gic_easy[]"
...
<!-- /page content -->
<script src="<?php echo base_url() ?>assets/js/gic_easy/sendKT.js"></script>

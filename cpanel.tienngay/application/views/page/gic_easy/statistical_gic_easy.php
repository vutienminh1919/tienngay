				...
				<div class="x_title">
					<div class="row">
						<div class="col-xs-12 col-lg-12">
							<div class="row">
								<form action="<?php echo base_url('gic_easy/statistical_gic_easy') ?>" method="get"
									  style="width: 100%;">
									<div class="col-lg-3">
										<label></label>
											...
											<tr style="text-align: center">
												...
												<td>
													<a class="btn btn-success"
													   href="<?= base_url() ?>gic_easy/list_gic_easy?fdate=<?= $fdate . '&tdate=' . $tdate . '&store=' . $mic->_id->{'$oid'} ?>" target="_blank">
														Chi tiết
													</a>
												</td>
											</tr>

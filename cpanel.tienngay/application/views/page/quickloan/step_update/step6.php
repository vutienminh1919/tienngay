        ...
        <div class="x_panel setup-content" id="step-6">
          <div class="x_content">
            ...
            <button class="btn btn-primary nextBtn pull-right" type="button" data-toggle="modal" data-target="#createContract">Cập nhật</button>
...
<div id="createContract" class="modal fade">
	<div class="modal-dialog modal-confirm">
        ...
        <button type="button" class="btn btn-success btn-update-contract"><?= $this->lang->line('ok')?></button>
			</div>
		</div>
	</div>
</div>

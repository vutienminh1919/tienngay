...
<head>
	...
	<title>Thông báo về việc có tài sản cẩn phê duyệt</title>
	<style>
					...
					<tr>
						<td class="wrapper"
							...
							<table border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td style="font-family: sans-serif; font-size: 14px; vertical-align: top;"><p
										...
										<strong>Kính gửi:
											<span>Trưởng bộ phận phê duyệt</span></strong>
										<p>Hiện tại đang có&nbsp;{count_property}&nbsp;{tab}&nbsp;{property}&nbsp;đã được thêm mới và đang chờ Trưởng Bộ Phận
											Phê Duyệt (TBP PD) xem xét phê duyệt.</p>
										<p>Bộ phận phê duyệt có thể xem chi tiết tài sản cần phê duyệt&nbsp;<a href='{url}'>tại đây.</a>
										</p>
									</td>
								</tr>
								</tbody>
							...
							<div class="footer"
								...
								<h5 style="font-weight: 600">CÔNG TY CỔ PHẦN CÔNG NGHỆ TÀI CHÍNH VIỆT</h5>
								...
								<p>Đây là email được gửi tự động từ Bộ Phận Định Giá của VFC. Vui lòng không
					...
					<table border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td class="content-block powered-by"
								...
								Thông báo phản hồi từ người BP Định Giá
							</td>
						</tr>
						</tbody>
					</table>

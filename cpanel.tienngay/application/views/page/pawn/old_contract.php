...
<div class="theloading" style="display:none" >
            ...
            <div class="page-title">
                <div class="title_left">
                    <h3><?= $this->lang->line('Contract_management')?>
                        <br>
                        <small>
                            <a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="#"><?php echo $this->lang->line('Contract_management')?></a>
                        </small>
                    </h3>
                </div>
                
                <div class="title_right text-right">
                    <!-- <button class="btn btn-info " data-toggle="modal" data-target="#addNewPawnModal"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</button> -->
                    ...
                    <div class="row">
                        ...
                        <?php if ($this->session->flashdata('error')) { ?>
                            ...
                            <div class="row">
								...
								<form action="<?php echo base_url('pawn/search')?>" method="get" style="width: 100%;">
									<div class="row">
										<div class="col-lg-2">
									...
									<div class="row">
										...
										<div class="col-lg-2 text-right col-lg-offset-6">
    ...
    <?php
     ...
     <li><a href="<?php echo base_url("pawn/detail?id=").$contract->_id->{'$oid'}?>" class="dropdown-item"> Chi tiết </li>
        ...
        <!-- <li><a href="javascript:void(0)" onclick="edit_fee(this)" data-id="<?= !empty($contract->_id->{'$oid'}) ? $contract->_id->{'$oid'} : ''?>"  class="btn btn-info yeu_cau_giai_ngan" > Sửa Phí</li> -->
        ...
        // check accessright của vận hành theo trạng thái 
            ...
            <?php
             // buttom edit fee
               ...
               <li><a  href="javascript:void(0)" onclick="edit_fee(this)" data-id="<?= !empty($contract->_id->{'$oid'}) ? $contract->_id->{'$oid'} : ''?>"  class="dropdown-item yeu_cau_giai_ngan" > Sửa Phí</li>
            <?php }?>

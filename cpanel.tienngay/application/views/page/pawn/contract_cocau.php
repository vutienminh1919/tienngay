	...
	<div class="row top_tiles">
		<div class="col-xs-12">
			<div class="page-title">
				<div class="row">
					<div class="col-xs-12">
						<h3><?= $this->lang->line('Contract_management') ?> cơ cấu
							<br>
							<small>
								<a href="<?php echo base_url() ?>"><i class="fa fa-home"></i> Home</a> / <a
										href="<?php echo base_url() ?>pawn/contract"><?php echo $this->lang->line('Contract_management') ?> cơ cấu</a>
							</small>
						</h3>
					</div>
				...
				<div class="x_title">
					<div class="row">
						<div class="col-xs-12">
							...
							<?php } ?>
							<div class="row">
								<form action="<?php echo base_url('pawn/search_cc') ?>" method="get" style="width: 100%;">
									<div class="col-xs-12">
										<div class="row">
											...
											<div class="col-xs-12 col-lg-2">
												...
												<select class="form-control" name="status">
													...
													<?php foreach (contract_status() as $key => $value) { 
														if(!in_array($key,[12,14,23,24,27,28,31,32,34,42])) continue;
														?>
...
<?php } ?> -->
															...
															<?php if (in_array('hoi-so', $groupRoles)) { ?>
																<?php if (in_array($contract->status, array(29))) { ?>
																	<li><a href="javascript:void(0)"

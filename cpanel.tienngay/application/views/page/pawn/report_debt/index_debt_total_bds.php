		...
		<div class="col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<div class="row">
						<ul class="nav nav-tabs" style="margin-bottom: 20px">
							...
							<li role="presentation" ><a href="<?php echo base_url() ?>report_kpi/index_report_debt_total">Báo
									cáo tổng hợp</a></li>
							<li role="presentation" class="active"><a href="<?php echo base_url() ?>report_kpi/index_report_debt_total_bds">Báo
					...
					<form action="<?php echo base_url('report_kpi/index_report_debt_total_bds') ?>" method="get" style="width: 100%;">
						<div class="row flex-search">
							...
							<div class="col-lg-2 col-md-2">
								<a style="background-color: #18d102;" target="_blank"
								   href="<?= base_url() ?>excel/index_report_debt_total_bds?date=<?= $date ?>"

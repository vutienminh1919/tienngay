				...
				<div class="x_content">
					<div class="row">
						...
						<div class="col-xs-12 col-md-6 text-right">
							<label class="radio-inline selectinvestor" data-target="investor_CTYCK"><input type="radio"
																										   value='1'
																										   name="investor_selected"
																										   checked>
								VFC
							</label>
							<label class="radio-inline selectinvestor" data-target="investor_VIMO"><input type="radio"
																										  value='2'
																										  name="investor_selected">
								VIMO
							</label>
							<label class="radio-inline selectinvestor" data-target="investor_PERSONAL"><input
										type="radio" value='3' name="investor_selected">
								Cá nhân
							</label>
						</div>
					</div>
				...
				<div class="x_content">
					<div id="investor_CTYCK" class="selectinvestor_action">
						...
						<div class="form-horizontal form-label-left">
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Ngày giải
									ngân</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<div id="investor_VIMO" class="selectinvestor_action d-none">
						...
						<div class="form-horizontal form-label-left">
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Hình
									thức</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">

...
<!--                  <button type="button" class="btn btn-primary identification_Face_search">Kiểm tra blacklist</button>-->
    ...
    <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          ...
          <input type="text" required value="<?= $contractInfor->customer_infor->customer_phone_number ? hide_phone($contractInfor->customer_infor->customer_phone_number) : "" ?>" class="form-control phone-autocomplete" >
          <input type="hidden" required id="customer_phone_number" value="<?= $contractInfor->customer_infor->customer_phone_number ? $contractInfor->customer_infor->customer_phone_number : "" ?>" class="form-control phone-autocomplete" >
           <input type="hidden" id="id_lead"  class="form-control" value="<?= $contractInfor->customer_infor->id_lead ?>">
        <?php }else{ ?>
    ...
    <div class="form-group row">
	  ...
	  <div class="form-group row">
		  ...
		  <div class="col-md-6 col-sm-6 col-xs-12">
			  <select class="form-control" id="customer_resources" disabled>
				  ...
				  <option value="VPS" <?= $contractInfor->customer_infor->customer_resources == "VPS" ? "selected" : "" ?>>Nguồn vay VPS</option>
				  <option value="MB" <?= $contractInfor->customer_infor->customer_resources == "MB" ? "selected" : "" ?>>Nguồn vay MB</option>
...
<!--									  <span class="timestamp">--><?php //echo date('d/m/Y H:i:s', basename($value->path));?><!--</span>-->
 ...
 <!--địa chỉ đang ở-->
      ...
      <button class="btn btn-primary  pull-right save_contract" data-step="<?= $contractInfor->step ? $contractInfor->step : "1" ?>"   type="button" data-toggle="modal" data-target="#saveContract">Lưu lại</button>

	...
	<div class="x_content">
		...
		<div class="form-group row">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				<input type="text" id="money" required class="form-control number"
					   value="<?= !empty($amount_money) ? number_format($amount_money) : "" ?>">
			</div>
		</div>
		...
		<div class="form-group row tra_lai">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<select class="form-control" id="type_interest">
					...
					<option id="type_interest_motobike" <?= !empty($contractInfor->loan_infor->type_property->code) && $contractInfor->loan_infor->type_property->code == "XM" ? 'style="display: none"' : "" ?>
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				<select class="form-control" id="number_day_loan">
					<option id="number_day_loan_motobike"
							value="1" <?= (($contractInfor->loan_infor->type_property->code == "XM") && $contractInfor->loan_infor->type_loan->code == "DKX") ? 'style="display: none"' : "" ?> <?= $contractInfor->loan_infor->number_day_loan / 30 == "1" ? "selected='selected'" : "" ?>>
						1 tháng
					</option>
					<option value="3"
							id="value3" <?= (($contractInfor->loan_infor->type_property->code == "XM") && $contractInfor->loan_infor->type_loan->code == "DKX") ? 'style="display: none"' : "" ?>  <?= $contractInfor->loan_infor->number_day_loan / 30 == "3" ? "selected='selected'" : "" ?>>
						3 tháng
					</option>
					<option id="value6"
		...
		<div class="form-group row">
			...
			<div class="col-lg-6 col-sm-12 col-12">
				<select class="form-control" name="gic_plt">
					<option value="CHON">-- Chọn gói bảo hiểm --</option>
				...
				foreach ($contractInfor->property_infor as $item) { ?>
					<?php if ($item->slug == "ngay-cap") { ?>
						<div class="form-group row ">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="date" name="property_infor" required id="<?= $item->slug ?>"
									   value="<?= $item->value ?>"
					...
					<?php } else { ?>
						<div class="form-group row ">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="property_infor" required id="<?= $item->slug ?>"
									   value="<?= $item->value ?>"
									   class="form-control property-infor" data-slug="<?= $item->slug ?>"
									   data-name="<?= $item->name ?>" placeholder="<?= $item->name ?>">
							</div>
		...
		<div class="form-group row form_gan_dinh_vi">
			...
			<div class="form-group row form_o_to_ngan_hang">
				...
				<button class="btn btn-primary nextBtnCreate pull-right btn_check_dkx" data-step="4" type="button">Tiếp
					tục
				</button>
				<?php
				...
				<button class="btn btn-primary  pull-right save_contract" type="button" data-toggle="modal"
						data-step="<?php echo $step ?>" data-target="#saveContract">Lưu lại
				</button>

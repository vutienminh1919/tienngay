	...
	<table class="table table-bordered">
		...
		<tr>
			...
			<td class="error_messages">
				<select style="width:100%;border:0" class="form-control formality" id="type_loan"
			...
			<td class="error_messages">
				<select style="width:100%;border:0" class="form-control" id="type_property"
			...
			<td class="error_messages">
				<select style="width:100%;border:0" class="form-control"
					...
					<option id="loan_product_1" value="1" <?= $dataInit['loan_product'] == 1 ? "selected" : "" ?> >Vay
						nhanh xe máy
					</option>
					<option id="loan_product_2" value="2" <?= $dataInit['loan_product'] == 2 ? "selected" : "" ?> >Vay
						theo đăng ký - cà vẹt xe máy
					</option>
					<option id="loan_product_3" value="3" <?= $dataInit['loan_product'] == 3 ? "selected" : "" ?> >Vay
						theo đăng ký - cà vẹt xe máy không chính chủ
					</option>
					<option id="loan_product_4" value="4" <?= $dataInit['loan_product'] == 4 ? "selected" : "" ?> >Cầm
						cố xe máy
					</option>
					<option id="loan_product_5" value="5" <?= $dataInit['loan_product'] == 5 ? "selected" : "" ?> >Cầm
						cố ô tô
					</option>
					<option id="loan_product_6" value="6" <?= $dataInit['loan_product'] == 6 ? "selected" : "" ?> >Vay
						nhanh ô tô
					</option>
					<option id="loan_product_7" value="7" <?= $dataInit['loan_product'] == 7 ? "selected" : "" ?> >Vay
						theo đăng ký - cà vẹt ô tô
					</option>
					<option id="loan_product_8" value="8" <?= $dataInit['loan_product'] == 8 ? "selected" : "" ?> >Vay
						tín chấp CBNV VFC
					</option>
					<option id="loan_product_9" value="9" <?= $dataInit['loan_product'] == 9 ? "selected" : "" ?> >Vay
						tín chấp CBNV tập đoàn
					</option>
					<option id="loan_product_15" value="15" <?= $dataInit['loan_product'] == 15 ? "selected" : "" ?> >
						Vay tín chấp CBNV Phúc Bình
					</option>
					<option id="loan_product_10" value="10" <?= $dataInit['loan_product'] == 10 ? "selected" : "" ?> >
						Vay theo xe CBNV VFC
					</option>
					<option id="loan_product_11" value="11" <?= $dataInit['loan_product'] == 11 ? "selected" : "" ?> >
						Vay theo xe CBNV tập đoàn
					</option>
					<option id="loan_product_12" value="12" <?= $dataInit['loan_product'] == 12 ? "selected" : "" ?> >
						Vay theo xe CBNV Phúc Bình
					</option>
					<option id="loan_product_13" value="13" <?= $dataInit['loan_product'] == 13 ? "selected" : "" ?> >
						Quyền sử dụng đất
					</option>
					<option id="loan_product_14" value="14" <?= $dataInit['loan_product'] == 14 ? "selected" : "" ?> >Bổ
						sung vốn kinh doanh Online
					</option>
					<option id="loan_product_16" value="16" <?= $dataInit['loan_product'] == 16 ? "selected" : "" ?> >Sổ đỏ
					</option>
					<option id="loan_product_17" value="17" <?= $dataInit['loan_product'] == 17 ? "selected" : "" ?> >Sổ hồng,
						...
						<?php foreach ($dataInit['minus'] as $item) { ?>
							<div>
								<label><input <?php echo !empty($detail) && $detail == 1 ? 'disabled' : '' ?>
											...
											name="price_depreciation" type="radio"
			...
			<td class="error_messages">
				<div class="input-group input-group-sm">
					...
					?>
					<input <?php echo !empty($detail) && $detail == 1 ? 'disabled' : '' ?> type="text"
																						   name='price_property'
																						   id='price_property'
																						   class="form-control "
																						   placeholder=""

	...
	<div class="row">
		<div class="col-xs-12">
			<div class="page-title">
				<h3><a href="<?php echo base_url() ?>new_contract/quanlyhopdong">Quản lý hợp đồng</a><a>/Tạo mới hợp đồng vay</a></h3>
			</div>
		</div>
		<div class="col-xs-12">
			...
			<form role="form" id="main_1" class="form-horizontal form-label-left" action="/example" method="post" novalidate>
				...
				<div class="form-horizontal form-label-left">
					<div class="setup-content" id="step-1">
						<?php $this->load->view('page/pawn/new_contract/create/quanlyhopdong_addnew_1');?>

					</div>

					<div class="setup-content" id="step-2">

						<?php $this->load->view('page/pawn/new_contract/create/quanlyhopdong_addnew_2');?>
					</div>

					<div class="setup-content" id="step-3">

						<?php $this->load->view('page/pawn/new_contract/create/quanlyhopdong_addnew_3');?>
					</div>
				</div>
			</form>

			...
			<div class="page-title">
				...
				<div class="title_right text-right">
					...
					if ($userSession['is_superadmin'] == 1 || in_array("5da98b8568a3ff2f10001b06", $userRoles->role_access_rights) || in_array('van-hanh', $groupRoles)) { ?>
						<a href="<?php echo base_url("pawn/createContract") ?>" class="btn btn-info "><i
									class="fa fa-plus" aria-hidden="true"></i> <?= $this->lang->line('create') ?></a>
													...
													<div class="dropdown">
														...
														<ul class="dropdown-menu" style="z-index: 99999">
															...
															if ($contract->status != 0) { ?>
																...
																<?php
																if ($userSession['is_superadmin'] == 1 || in_array("tbp-thu-hoi-no", $groupRoles) || in_array("ke-toan", $groupRoles)) { ?>
																	<li>
...
<script>
	...
	$('#submit_customer_identify_check').click(function (event) {
		event.preventDefault();
		let customer_identify = $('#customer_identify_check').val();
		console.log(customer_identify)

		$.ajax({
			url: _url.base_url + '/pawn/checkContract',
			method: "POST",
			data: {
			...
			success: function (data) {
				...
				if (data.data.status == 200) {
					...
					$(".msg_success").text('Tạo hợp đồng từ CMT thành công');

<link rel="stylesheet" href="<?php echo base_url(); ?>assets/home/css/detail_kt/disbursement_new.css">
<!-- -------------- -->
<div class="right_col" role="main">
	...
	<div class="nhadautu">
		<div class="nhadautu-top">
			...
			<div class="ip-radio">
				<div>
					<input checked type="radio" id="vfc" name="investor_selected" value="1">
					<label for="">VFC</label>
				</div>
				<div>
					<input type="radio" id="vimo" name="investor_selected" value="2">
					<label for="">VIMO</label>
				</div>
				<div>
					<input type="radio" id="self" name="investor_selected" value="3">
					<label for="">Cá nhân</label>
				</div>
			</div>

		</div>
		<div class="date_giaingan">
			<div class="ip-1">
				<p>Ngày giải ngân</p>
				<input type="text" id="timeCheckIn" value="<?php echo date("m/d/Y") ?>">
			</div>
			<div class="ip-2" style="display:none">
				<p>Nhà đầu tư</p>
				<select id='investor' >
			...
			<div class="ip-3" style="display:none">
				<p>Hình thức</p>
				<select class="type_payout_bank">
					<?php
					// hình thức chuyển khoản tài khoản ngân hàng
					if ($type_payout == 2) {
						?>
	...
	<div class="giaingan-ft">
		<a type="button" class="btn btn-secondary btn-quaylai" href="<?php echo base_url('pawn/contract') ?>" style="background:#EBEBEB;width: 211px;">Quay lại</a>
		<button type="button" class="btn btn-success" data-toggle="modal" data-target="#approve_disbursement">Giải ngân hợp đồng</button>

    ...
    <div class="col-xs-12">
        <div class="page-title">
            <div class="title_left">
                <h3><?php echo $this->lang->line('create_user_phonenet')?>
                  <br/><br/>
                  <small><a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="<?php echo base_url('user_phonenet/listUser_phonenet')?>"><?php echo $this->lang->line('user_phonenet_list')?></a> / <a href="#"><?php echo $this->lang->line('create_user_phonenet')?></a></small>
                </h3>
            </div>
        </div>
    </div>
        ...
        <span class='div_error'></span>
		              ...
		              <div class="col-md-6 col-sm-6 col-xs-12">
		                  ...
		                  <?php 
		                    if(!empty($userData)){
		                      ...
		                      <option  value="<?= !empty($user->email) ? $user->email : "" ?>"><?= !empty($user->email) ? $user->email : "";?></option>
		                      <?php }}?>
		                  </select>
					...
					<div class="form-group">
									<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
										<button class="btn btn-success  create_user_phonenet">

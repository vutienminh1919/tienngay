	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<div class="row">
					<div class="col-xs-12">
						<h3><?php echo $this->lang->line('receipts_list') ?>
							<br>
							<small>
								<a href="<?php echo base_url() ?>"><i class="fa fa-home"></i> Home</a> / <a href="#>"><?php echo $this->lang->line('receipts_list') ?></a>
							</small>
						</h3>
					</div>
				</div>
			...
			<div class="x_content">
				<div class="row">
					<div class="col-xs-12">
						<div class="row">
							<form action="<?php echo base_url('transaction/transaction_v2') ?>" method="get"
								  style="width: 100%">
								<div class="col-xs-12">
									<div class="row">
										<!-- 	  <div class="col-lg-2">

<html><head>
	...
	<style type="text/css">
		...
		.lst-kix_list_23-0>li:before {
			content: "3. " counter(lst-ctn-kix_list_23-0, decimal) ". "
		}
		...
		.lst-kix_list_24-0>li:before {
			content: "11." counter(lst-ctn-kix_list_24-0, decimal) ". "
		}
		...
		.lst-kix_list_22-0>li:before {
			content: "10." counter(lst-ctn-kix_list_22-0, decimal) ". "
		}
		...
		.lst-kix_list_21-0>li:before {
			content: "9." counter(lst-ctn-kix_list_21-0, decimal) ". "
		}
		...
		.lst-kix_list_26-0>li:before {
			content: "14." counter(lst-ctn-kix_list_26-0, decimal) ". "
		}
		...
		.lst-kix_list_25-0>li:before {
			content: "9." counter(lst-ctn-kix_list_25-0, decimal) ". "
		}
		...
		.lst-kix_list_27-0>li:before {
			content: "15." counter(lst-ctn-kix_list_27-0, decimal) ". "
		}
		...
		.lst-kix_list_28-0>li:before {
			content: "16." counter(lst-ctn-kix_list_28-0, decimal) ". "
		}
		...
		.lst-kix_list_14-0>li:before {
			content: "5." counter(lst-ctn-kix_list_14-0, decimal) ". "
		}
		...
		.lst-kix_list_17-0>li:before {
			content: "" counter(lst-ctn-kix_list_17-0, lower-latin) ") "
		}
		...
		.lst-kix_list_15-0>li:before {
			content: "6. " counter(lst-ctn-kix_list_15-0, decimal) ". "
		}
		...
		.lst-kix_list_12-0>li:before {
			content: "4. " counter(lst-ctn-kix_list_12-0, decimal) ". "
		}
		...
		.lst-kix_list_13-0>li:before {
			content: "4. " counter(lst-ctn-kix_list_13-0, decimal) ". "
		}
		...
		.lst-kix_list_19-0>li:before {
			content: "7." counter(lst-ctn-kix_list_19-0, decimal) ". "
		}
		...
		.lst-kix_list_20-0>li:before {
			content: "8." counter(lst-ctn-kix_list_20-0, decimal) ". "
		}
		...
		.c11 {
			padding-top: 6pt;
			padding-bottom: 8pt;
			line-height: 1.2041666666666666;
			orphans: 2;
			widows: 2;
			text-align: justify;
			height: 11pt
...
?>
<div>
	<p class="c5"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 184.28px; height: 44.45px;"><img alt="" src="<?php echo base_url('assets/build/')?>images/image4.png" style="width: 184.28px; height: 44.45px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p>
</div>
<p class="c20"><span class="c17 c43">THỎA THUẬN BA BÊN</span></p>
<p class="c20"><span class="c22">Về việc hỗ trợ tài chính</span></p>
<br/>
<p class="c46"><span class="c24 c26">....................................</span></p>
<!-- <p class="c46"><span class="c24 c26">Số: </span><span class="c24 c44"> <?php echo !empty($contract->code_contract) ? $contract->code_contract : ''?>.</span></p> -->
<p class="c6"><span class="c0">Hôm nay, ngày <?php echo $mydate['mday']?> tháng <?php echo $mydate['mon']?> năm <?php echo $mydate['year']?>, tại <?php echo $contract->store->address?>.</span></p>
<p class="c6"><span class="c0">Các Bên gồm:</span></p>
<a id="t.c6e78288ac5d761aabd520087ba8cc7802aca872"></a>
<a id="t.0"></a>
<table class="c4">
	<tbody>
	<tr class="c8">
		<td class="c7" colspan="1" rowspan="1">
			<p class="c5"><strong class="c0">Bên Vay:</strong></p>
		</td>
		<td class="c30" colspan="1" rowspan="1">
		</td>
		<td class="c3" colspan="1" rowspan="1">
			<p class="c5"><strong class="c0">Bên Cho Vay:</strong></p>
		</td>
	...
	<tr class="c8">
		<td class="c7" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">Họ và tên</span></p>
		</td>
		<td class="c30" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">: <?php echo $contract->customer_infor->customer_name?>.</span></p>
		</td>
		<td class="c3" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">Họ và tên</span></p>
		</td>
	...
	<tr class="c8">
		<td class="c7" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">Ngày sinh</span></p>
		</td>
		<td class="c30" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">: <?php echo $customerDOB?>.</span></p>
		</td>
		<td class="c3" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">Ngày sinh</span></p>
		</td>
	...
	<tr class="c8">
		<td class="c7" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">Số CMND/CCCD/Hộ chiếu</span></p>
		</td>
		<td class="c30" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">: <?php echo $contract->customer_infor->customer_identify?>.</span></p>
		</td>
		<td class="c3" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">Số CMND/CCCD/Hộ chiếu</span></p>
		</td>
	...
	<tr class="c8">
		<td class="c7" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">Địa chỉ nơi ở hiện tại</span></p>
		</td>
		<td class="c30" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">: <?php echo $address?>.</span></p>
		</td>
		<td class="c3" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">Địa chỉ nơi ở hiện tại</span></p>
		</td>
	...
	<tr class="c8">
		<td class="c7" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">Số tài khoản/Số thẻ</span></p>
		</td>
		<td class="c30" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">: <strong><?php echo !empty($contract->receiver_infor->bank_account) ? $contract->receiver_infor->bank_account : $contract->receiver_infor->atm_card_number?></strong>.</span></p>
		</td>
		<td class="c3" colspan="1" rowspan="1">
			<p class="c5 c12"><span class="c0"></span></p>
		</td>
		<td class="c15" colspan="1" rowspan="1">
			<p class="c5 c12"><span class="c0"></span></p>
		</td>
	...
	<tr class="c8">
		<td class="c7" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">tại Ngân hàng: <strong><?php echo $bank_name?></strong>.</span></p>
		</td>
		<td class="c30" colspan="1" rowspan="1">
			<p class="c5"><span class="c0">Chi nhánh: <strong><?php echo $contract->receiver_infor->bank_branch?></strong>.</span></p>
		</td>
		<td class="c3" colspan="1" rowspan="1">
			<p class="c5 c12"><span class="c0"></span></p>
		</td>
...
<table class="c4">
	...
	<tr class="c8">
		<td class="c7" colspan="1" rowspan="1">
			<p class="c27"><span class="c19 c24">Sau đây gọi tắt là </span><span class="c9 c24">“Bên Vay”</span></p>
		</td>
		<td class="c30" colspan="1" rowspan="1">

		</td>
		<td class="c3" colspan="1" rowspan="1">
			<p class="c27"><span class="c19 c24">Sau đây gọi tắt là </span><span class="c9 c36 c24">“Bên Cho Vay”</span></p>
		</td>
		<td class="c15" colspan="1" rowspan="1">
...
<p class="c29"><span class="c17 c9">Bên cung cấp dịch vụ: CÔNG TY CỔ PHẦN CÔNG NGHỆ TÀI CHÍNH VIỆT </span></p>
<p class="c29"><span class="c0">Địa chỉ trụ sở chính: Tầng 15, khối B, toà nhà Sông Đà, đường Phạm Hùng, Nam Từ Liêm, thành phố Hà Nội</span></p>
<p class="c29"><span class="c0">Địa điểm giao dịch: <?php echo $contract->store->name?>. Đại diện bởi: <?php echo isset($store->representative) ? $store->representative : '.....................................'?>. Giấy ủy quyền số:.............................................</span></p>
<p class="c29"><span class="c19 c24">Sau đây gọi tắt là </span><span class="c9 c24 c36">“VFC”</span></p>
<p class="c41"><span class="c19">Các Bên đồng ý và thống nhất ký kết thỏa thuận hỗ trợ tài chính này (Sau đây gọi tắt là </span><span class="c9">“Thỏa Thuận”</span><span class="c0">) với các điều khoản và điều kiện cụ thể như sau:</span></p>
<a id="t.90051279b1bdad214fd0b0f1e8f94b0fe8dd38d2"></a>
<a id="t.1"></a>
<table class="c4">
	<tbody>
	<tr class="c8">
		<td class="c42" colspan="1" rowspan="1">
			<ol class="c2 lst-kix_list_2-0 start" start="1">
				<li class="c13"><span class="c17 c9">THÔNG TIN SỐ TIỀN VAY</span></li>
			</ol>
			<ol class="c2 lst-kix_list_3-0 start" start="1">
				<li class="c10"><span class="c0">Số Tiền Vay: <strong><?php echo number_format($contract->loan_infor->amount_money ,0 ,'.' ,'.').' đ'?></strong>.</span></li>
				<li class="c10"><span class="c0">Lãi Suất: <strong>1,5%/tháng</strong>.</span></li>
				<li class="c10"><span class="c0">Mục đích vay: <?php echo !empty($contract->loan_infor->loan_purpose) ? $contract->loan_infor->loan_purpose : '.........................................................'?>.</span></li>
			</ol>
			<p class="c32"><span class="c0">Bên Vay cam kết sử dụng Số Tiền Vay theo đúng mục đích mà Bên Vay đã nêu. Bên Vay hoàn toàn chịu trách nhiệm trước pháp luật và Bên Cho Vay về việc sử dụng Số Tiền Vay đúng mục đích, đồng thời, miễn trừ mọi trách nhiệm pháp lý liên quan đối với Bên Cho Vay và VFC nếu</span><span class="c19">&nbsp;</span><span class="c0">Bên Vay vi phạm điều khoản này.</span></p>
			<ol class="c2 lst-kix_list_3-0" start="4">
				<li class="c10"><span class="c0">Ngày Giải Ngân: <?php echo !empty($contract->disbursement_date) ? date('d/m/Y', intval($contract->disbursement_date) + 7*60*60) : '.........................................................'?>. </span></li>
				<li class="c10">
					<span class="c0">Hình thức giải ngân: </span>
					<span class="c0">Qua số thẻ/tài khoản ngân hàng </span>
				</li>
			</ol>
			<ol class="c2 lst-kix_list_3-0" start="6">
				<li class="c10"><span class="c0">Thời hạn vay: <strong><?php echo $contract->loan_infor->number_day_loan?> ngày</strong>.</span></li>
				<li class="c10"><span class="c0">Kỳ thanh toán: <strong><?php echo $contract->loan_infor->period_pay_interest?> ngày</strong>.</span></li>
				<li class="c10"><span class="c0">Phương thức thanh toán:</span>
					<?php if ($contract->loan_infor->type_interest == 1) { ?>
						<span class="c0">Thanh toán gốc, lãi và các khoản phí (nếu có) hàng tháng theo thông báo cụ thể của VFC</span>
					<?php } else { ?>
						<span class="c0">Thanh toán gốc cuối kỳ, lãi và các khoản phí (nếu có) hàng tháng</span>
					<?php } ?>
				</li>
			</ol>
			<ol class="c2 lst-kix_list_3-0" start="9">
				<li class="c10"><span class="c0">Tổng số tiền phải trả hàng tháng: <strong><?php echo !empty($money) ?  number_format($money ,0 ,'.' ,'.').' đ' : '...................'?></strong>.</span></li>
				<li class="c31 c39"><span class="c0">Phí trả nợ trước hạn: theo thông báo của VFC tại từng thời điểm</span></li>
				<li class="c31 c39"><span class="c0">Phí quản lý số tiền vay chậm trả: theo thông báo của VFC tại từng thời điểm</span></li>
				<li class="c31 c39"><span class="c0">Phí thẩm định và lưu trữ tài sản Đảm Bảo (nếu có): theo thông báo của VFC tại từng thời điểm</span></li>
				<li class="c34"><span class="c0">Phí tư vấn gia hạn số tiền vay: theo thông báo của VFC tại từng thời điểm</span></li>
			</ol>
		</td>
		<td class="c21" colspan="1" rowspan="1">
			<ol class="c2 lst-kix_list_2-0" start="2">
				<li class="c25"><span class="c17 c9">THANH TOÁN PHÍ TƯ VẤN QUẢN LÝ</span></li>
			</ol>

			<ol class="c2 lst-kix_list_5-0 start" start="1">
				<li class="c16"><span class="c0">Phí tư vấn quản lý là khoản phí mà Bên Vay phải thanh toán cho VFC khi VFC cung cấp Dịch Vụ Tư Vấn Quản Lý (quy định cụ thể tại Điều Khoản Chung) cho Bên Vay.</span></li>
				<li class="c16"><span class="c0">Kỳ thanh toán Phí tư vấn quản lý: <strong><?php echo $contract->loan_infor->period_pay_interest?> ngày</strong>.</span></li>
				<li class="c16"><span class="c0">Phí tư vấn quản lý: thanh toán theo chính sách chung của VFC tại từng thời điểm.</span></li>
			</ol>
			<ol class="c2 lst-kix_list_2-0" start="3">
				<li class="c25"><span class="c17 c9">THÔNG TIN TÀI SẢN ĐẢM BẢO (Nếu có)</span></li>
			</ol>

			<p class="c14"><span class="c0">Bên Vay cam kết Tài sản đảm bảo thuộc sở hữu hợp pháp của Bên Vay và có thông tin cụ thể như sau:</span></p>
			<ol class="c2 lst-kix_list_6-0 start" start="1">
				<li class="c1"><span class="c0">Tài sản đảm bảo: <strong><?php echo $contract->loan_infor->type_property->text?></strong>.</span></li>
				<li class="c1"><span class="c0">Thông tin Tài sản đảm bảo:</span></li>
			</ol>
			<p class="c23"><span class="c0">Nhãn hiệu: <strong><?php echo $nhanhieu?></strong>.   Model: <strong><?php echo $model?></strong>.</span></p>
			<p class="c23"><span class="c0">Số khung:  <strong><?php echo $sokhung?></strong>.   Số máy: <strong><?php echo $somay?></strong>.</span></p>
			<p class="c23"><span class="c0">Biểm kiểm soát: <strong><?php echo $bienkiemsoat?></strong>.</span></p>
			<ol class="c2 lst-kix_list_6-0" start="3">
				<li class="c1"><span class="c0">Các giấy tờ của Tài sản đảm bảo được Bên Vay bàn giao cho VFC (giấy tờ gốc):</span><span class="c19">&nbsp;</span><span class="c0">...................................................................................................</span></li>
			</ol>
			<p class="c18"><span class="c0">Số</span><span class="c19">&nbsp;</span><span class="c0">đăng</span><span class="c19">&nbsp;</span><span class="c0">ký: ..................................... cấp ngày .................................</span></p>
			<p class="c35"><span class="c36 c19 c24">* Các quy định chi tiết về Số Tiền Vay và quyền và nghĩa vụ của Các Bên trong Thỏa Thuận này sẽ được quy định tại Điều Khoản Chung. Điều Khoản Chung này là một phần không thể tách rời khỏi Thỏa Thuận và đã được Các Bên đọc, hiểu và đồng ý cam kết thực hiện</span></p>
		</td>
	</tr>
	<tr class="c8">
		<td class="c28" colspan="2" rowspan="1">
			<p class="c31" id="h.gjdgxs" style="text-align:center">
				<span class="c9 c17">BÊN VAY &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; BÊN CHO VAY &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ĐẠI DIỆN VFC</span></p>
		</td>
	</tr>
	</tbody>
</table>
<p class="c11"><span class="c17 c45"></span></p>

    ...
    <div class="row top_tiles">
        <div class="col-xs-12">
            ...
            <h3>Thêm mới nhóm quyền
                <br>
					<small>
					<a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="<?php echo base_url('groupRole/search')?>">Thiết lập nhóm quyền</a> / <a href="#">Thêm mới nhóm quyền</a> 
					</small>
                </h3>
            </div>
        </div>
                ...
                <div class="x_title">
                    <div class="row">
                        <div class="col-xs-12 col-lg-11">
                            <div class="row">
                                <div class="col-lg-3">
                                    <input id="role_name" class="form-control" type="text" placeholder="Tên group role">
                                </div>

    ...
    <div class="col-xs-12">
        <div class="page-title">
            <div class="title_left">
                <h3>Báo cáo tổng hợp số HĐ, volume
                <br>
                <small>
                    <a href="<?php echo base_url()?>"><i class="fa fa-home" ></i> Home</a> / <a href="#">Báo cáo tổng hợp số HĐ, volume</a>
                </small>
                </h3>
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <?php if ($this->session->flashdata('error_excel_contract_volume')) { ?>
                                <div class="alert alert-danger alert-result">
                                    <?= $this->session->flashdata('error_excel_contract_volume') ?>
                                </div>
                                <?php } ?>
                                ...
                                <?php } ?>
                                <div class="row">
                                    <form action="<?php echo base_url('accountingSystem/exportContractVolume')?>" method="get" style="width: 100%;">
                                        <div class="col-lg-3">

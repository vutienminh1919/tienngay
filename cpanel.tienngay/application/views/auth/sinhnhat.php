                    ...
                    <div class="col-xs-12 col-md-6 col-lg-5" style="max-width:434px">
                        <div class="panel panel-default panel-login">
                            ...
                            <form action="<?= base_url('auth/doLogin') ?>" method="post">
                                ...
                                <button type="submit" class="btn btn-login label-login">Chúc mừng sinh nhật VFC</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    #thelogin {
        background: url('./assets/build/images/sinhnhat.svg') no-repeat;
        overflow: hidden;
    ...
    .label-login {
        background: radial-gradient(50% 88.89% at 50% 50%, #FFF385 0%, #FFD600 45.37%, #E38800 100%) !important;

	...
	<div id="particles-js" class="main_container">
		<div class="container">
			...
			<div class="row flex">
                ...
                <img style="width: auto; margin: 0 auto 0;display: block"
							 src="<?php echo base_url(); ?>assets/build/images/img_title_valentine.png" alt="">
...
<style>
	...
	#thelogin {
		background: url('./assets/build/images/bg_valentine.png') #F98390 no-repeat;
		overflow: hidden;
	...
	#thelogin .panel-login {
		position: relative;
		z-index: 9999;
		background: url('./assets/build/images/bg_panel_login.png') #fff no-repeat;

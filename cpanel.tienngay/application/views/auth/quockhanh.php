...
<div id="thelogin" class="container body">
	<div id="particles-js" class="main_container">
		<div class="container">
			<div class="row flex" >
				<div class="col-xs-12 col-md-6 col-lg-5 formLogin" >
					<div class="panel panel-default panel-login">
						...
						<form action="<?= base_url('auth/doLogin') ?>" method="post">
							...
							<button type="submit" class="btn btn-login">Chuyển hóa để vươn xa</button>
						</form>
					</div>
				</div>
			</div>
...
<style>
	...
	#thelogin {
		background: url('./assets/build/images/quockhanh.png') #F98390 no-repeat;
		overflow: hidden;

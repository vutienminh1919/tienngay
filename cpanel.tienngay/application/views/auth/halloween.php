				...
				<div class="col-xs-12 col-md-6 col-lg-5" style="max-width:434px">
					<div class="panel panel-default panel-login">
						...
						<img style="width: auto; margin: 0 auto 30px;display: block"
							 src="<?php echo base_url(); ?>assets/imgs/logos.png" alt="">
						<form action="<?= base_url('auth/doLogin') ?>" method="post">
							...
							<div class="form-group">
								<p class="thelinks text-center" style=" text-align: left;">

									<span style="color: #FFF1C0;">Quên mật khẩu? <a href="<?php echo base_url('auth/forgot') ?>">Lấy lại mật khẩu</a> </span>
								</p>
							</div>
							<?php echo $widget; ?>
							<?php echo $script; ?>
							...
							<button type="submit" class="btn btn-login" style="background-color: #FEE89C; 
                            color: #2A0101;font-weight: 600;font-size: 16px;
                            line-height: 20px; padding: 10px;">Cho kẹo hay bị ghẹo</button>
						</form>
					</div>
				</div>
			</div>
...
<style>
	...
	#thelogin {
		background: url(https://service.tienngay.vn/uploads/avatar/1666765011-8a1c340081765f24d4688a0ce1ea0ef8.png) no-repeat;
		overflow: hidden;

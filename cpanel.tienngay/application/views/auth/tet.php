...
<body class="page_login nav-md">
	...
	<div class="banhtrung">
		<img src="<?php echo base_url(); ?>assets/build/images/banhtrungto.png" alt="bangtrung" />
	</div>
				...
				<div class="row flex">
					<div class="col-xs-12 col-md-6 col-lg-5" style="max-width:434px">
						<div class="panel panel-default panel-login">
							...
							<img style="width: auto; margin: 0 auto 30px;display: block" src="<?php echo base_url(); ?>assets/imgs/logo.png" alt="">
							<form action="<?= base_url('auth/doLogin') ?>" method="post">
								...
								<button type="submit" class="btn btn-login">Đón chào năm mới </button>
							</form>
						</div>
					</div>
				</div>
	...
	<div class="banhtrungnho">
		<img src="<?php echo base_url(); ?>assets/build/images/banhtrungsmall.png" alt="banhtrungsmall" />
	</div>
	<div class="hoadao">
		<img src="<?php echo base_url(); ?>assets/build/images/hoadao.png" alt="hoadao" />
	</div>
	<script>
...
<style>
	...
	#thelogin {
		background: url('./assets/build/images/backtet.png') no-repeat;
		overflow: hidden;
